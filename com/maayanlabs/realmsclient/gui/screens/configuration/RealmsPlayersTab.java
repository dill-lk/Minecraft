...
import com.maayanlabs.realmsclient.gui.screens.RealmsConfirmScreen;
...
import com.maayanlabs.realmsclient.gui.screens.configuration.RealmsInviteScreen;
...
implements RealmsConfigurationTab {
    ...
    RealmsPlayersTab(RealmsConfigureWorldScreen configurationScreen, Mayaan minecraft, RealmsServer serverData) {
        super(TITLE);
    ...
    extends ContainerObjectSelectionList<Entry> {
        ...
        public InvitedObjectSelectionList(RealmsPlayersTab realmsPlayersTab, int width, int height) {
            ...
            super(Mayaan.getInstance(), width, height, realmsPlayersTab.configurationScreen.getHeaderHeight(), 36);
        }
