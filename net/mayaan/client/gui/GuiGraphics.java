...
import net.mayaan.client.gui.screens.inventory.tooltip.DefaultTooltipPositioner;
import net.mayaan.client.gui.screens.inventory.tooltip.TooltipRenderUtil;
...
import net.mayaan.client.renderer.state.gui.BlitRenderState;
...
import net.mayaan.client.renderer.state.gui.TiledBlitRenderState;
...
public class GuiGraphics {
    ...
    private GuiGraphics(Mayaan minecraft, Matrix3x2fStack pose, GuiRenderState guiRenderState, int mouseX, int mouseY) {
    ...
    public GuiGraphics(Mayaan minecraft, GuiRenderState guiRenderState, int mouseX, int mouseY) {
