...
import net.mayaan.client.gui.components.events.AbstractContainerEventHandler;
...
import net.mayaan.client.gui.narration.ScreenNarrationCollector;
...
implements Renderable {
    ...
    protected Screen(Component title) {
        this(Mayaan.getInstance(), Mayaan.getInstance().font, title);
    }

    protected Screen(Mayaan minecraft, Font font, Component title) {
    ...
    public static List<Component> getTooltipFromItem(Mayaan minecraft, ItemStack itemStack) {
     ...
     */
    protected static void defaultHandleGameClickEvent(ClickEvent event, Mayaan minecraft, @Nullable Screen activeScreen) {
    ...
    protected static boolean clickUrlAction(Mayaan minecraft, @Nullable Screen screen, URI uri) {
