...
import net.mayaan.client.gui.screens.inventory.CyclingSlotBackground;
import net.mayaan.client.gui.screens.inventory.ItemCombinerScreen;
...
import net.mayaan.world.item.SmithingTemplateItem;
