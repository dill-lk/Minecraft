...
import net.mayaan.client.gui.screens.reporting.ChatReportScreen;
import net.mayaan.client.gui.screens.reporting.NameReportScreen;
import net.mayaan.client.gui.screens.reporting.SkinReportScreen;
import net.mayaan.client.gui.screens.social.PlayerEntry;
...
extends Screen {
    ...
    protected void init() {
        ...
        Button chatButton = this.layout.addChild(Button.builder(REPORT_CHAT, b -> this.minecraft.setScreen(new ChatReportScreen(this.lastScreen, this.context, this.player.getPlayerId()))).build());
