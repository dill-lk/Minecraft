...
import net.mayaan.client.gui.components.toasts.AdvancementToast;
...
public class ClientAdvancements {
    ...
    public ClientAdvancements(Mayaan minecraft, WorldSessionTelemetryManager telemetryManager) {
