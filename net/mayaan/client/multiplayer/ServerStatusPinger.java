...
import net.mayaan.client.multiplayer.LegacyServerPinger;
                ...
                status.players().ifPresentOrElse(players -> {
                    ...
                    if (!players.sample().isEmpty()) {
                        ...
                        for (NameAndId profile : players.sample()) {
                            MutableComponent playerName = profile.equals(MayaanServer.ANONYMOUS_PLAYER_PROFILE) ? Component.translatable("multiplayer.status.anonymous_player") : Component.literal(profile.name());
