...
import net.mayaan.world.item.ShieldItem;
...
public class ItemInHandRenderer {
    ...
    public ItemInHandRenderer(Mayaan minecraft, EntityRenderDispatcher entityRenderDispatcher, ItemModelResolver itemModelResolver) {
