...
import com.maayanlabs.blaze3d.resource.RenderTargetDescriptor;
...
import net.mayaan.client.renderer.CloudRenderer;
...
import net.mayaan.client.renderer.ShapeRenderer;
import net.mayaan.client.renderer.SkyRenderer;
import net.mayaan.client.renderer.SubmitNodeCollector;
import net.mayaan.client.renderer.SubmitNodeStorage;
import net.mayaan.client.renderer.ViewArea;
import net.mayaan.client.renderer.WeatherEffectRenderer;
import net.mayaan.client.renderer.WorldBorderRenderer;
...
import net.mayaan.client.renderer.chunk.CompiledSectionMesh;
import net.mayaan.client.renderer.chunk.RenderRegionCache;
import net.mayaan.client.renderer.chunk.SectionCompiler;
import net.mayaan.client.renderer.chunk.SectionMesh;
...
import net.mayaan.client.renderer.debug.GameTestBlockHighlightRenderer;
...
import net.mayaan.client.renderer.gizmos.DrawableGizmoPrimitives;
...
import net.mayaan.server.level.BlockDestructionProgress;
...
AutoCloseable {
    ...
    public LevelRenderer(Mayaan minecraft, EntityRenderDispatcher entityRenderDispatcher, BlockEntityRenderDispatcher blockEntityRenderDispatcher, RenderBuffers renderBuffers, GameRenderState gameRenderState, FeatureRenderDispatcher featureRenderDispatcher) {
    ...
    private @Nullable PostChain getTransparencyChain() {
        if (!Mayaan.useShaderTransparency()) {
            return null;
        }
    ...
    private void applyFrustum(Frustum frustum) {
        if (!Mayaan.getInstance().isSameThread()) {
