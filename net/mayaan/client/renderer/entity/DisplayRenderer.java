...
import net.mayaan.client.renderer.entity.state.BlockDisplayEntityRenderState;
import net.mayaan.client.renderer.entity.state.DisplayEntityRenderState;
import net.mayaan.client.renderer.entity.state.ItemDisplayEntityRenderState;
import net.mayaan.client.renderer.entity.state.TextDisplayEntityRenderState;
    ...
    extends DisplayRenderer<Display.TextDisplay, Display.TextDisplay.TextRenderState, TextDisplayEntityRenderState> {
        ...
        public void submitInner(TextDisplayEntityRenderState state, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int lightCoords, float interpolationProgress) {
            ...
            if (useDefaultBackground) {
                float backgroundAlpha = Mayaan.getInstance().gameRenderer.getGameRenderState().optionsRenderState.getBackgroundOpacity(0.25f);
