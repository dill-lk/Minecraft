...
import net.mayaan.client.model.animal.squid.SquidModel;
import net.mayaan.client.model.geom.ModelLayers;
import net.mayaan.client.renderer.entity.AllayRenderer;
import net.mayaan.client.renderer.entity.ArmadilloRenderer;
import net.mayaan.client.renderer.entity.ArmorStandRenderer;
import net.mayaan.client.renderer.entity.AxolotlRenderer;
import net.mayaan.client.renderer.entity.BatRenderer;
import net.mayaan.client.renderer.entity.BeeRenderer;
import net.mayaan.client.renderer.entity.BlazeRenderer;
import net.mayaan.client.renderer.entity.BoatRenderer;
import net.mayaan.client.renderer.entity.BoggedRenderer;
import net.mayaan.client.renderer.entity.BreezeRenderer;
import net.mayaan.client.renderer.entity.CamelHuskRenderer;
import net.mayaan.client.renderer.entity.CamelRenderer;
import net.mayaan.client.renderer.entity.CatRenderer;
import net.mayaan.client.renderer.entity.CaveSpiderRenderer;
import net.mayaan.client.renderer.entity.ChickenRenderer;
import net.mayaan.client.renderer.entity.CodRenderer;
import net.mayaan.client.renderer.entity.CopperGolemRenderer;
import net.mayaan.client.renderer.entity.CowRenderer;
import net.mayaan.client.renderer.entity.CreakingRenderer;
import net.mayaan.client.renderer.entity.CreeperRenderer;
import net.mayaan.client.renderer.entity.DisplayRenderer;
import net.mayaan.client.renderer.entity.DolphinRenderer;
import net.mayaan.client.renderer.entity.DonkeyRenderer;
import net.mayaan.client.renderer.entity.DragonFireballRenderer;
import net.mayaan.client.renderer.entity.DrownedRenderer;
...
import net.mayaan.client.renderer.entity.EndermanRenderer;
import net.mayaan.client.renderer.entity.EndermiteRenderer;
import net.mayaan.client.renderer.entity.EntityRenderer;
import net.mayaan.client.renderer.entity.EntityRendererProvider;
import net.mayaan.client.renderer.entity.EvokerFangsRenderer;
import net.mayaan.client.renderer.entity.EvokerRenderer;
import net.mayaan.client.renderer.entity.ExperienceOrbRenderer;
import net.mayaan.client.renderer.entity.FallingBlockRenderer;
import net.mayaan.client.renderer.entity.FireworkEntityRenderer;
import net.mayaan.client.renderer.entity.FishingHookRenderer;
import net.mayaan.client.renderer.entity.FoxRenderer;
import net.mayaan.client.renderer.entity.FrogRenderer;
import net.mayaan.client.renderer.entity.GhastRenderer;
import net.mayaan.client.renderer.entity.GiantMobRenderer;
import net.mayaan.client.renderer.entity.GlowSquidRenderer;
import net.mayaan.client.renderer.entity.GoatRenderer;
import net.mayaan.client.renderer.entity.GuardianRenderer;
import net.mayaan.client.renderer.entity.HappyGhastRenderer;
import net.mayaan.client.renderer.entity.HoglinRenderer;
import net.mayaan.client.renderer.entity.HorseRenderer;
import net.mayaan.client.renderer.entity.HuskRenderer;
import net.mayaan.client.renderer.entity.IllusionerRenderer;
import net.mayaan.client.renderer.entity.IronGolemRenderer;
import net.mayaan.client.renderer.entity.ItemEntityRenderer;
import net.mayaan.client.renderer.entity.ItemFrameRenderer;
import net.mayaan.client.renderer.entity.LeashKnotRenderer;
import net.mayaan.client.renderer.entity.LightningBoltRenderer;
import net.mayaan.client.renderer.entity.LlamaRenderer;
import net.mayaan.client.renderer.entity.LlamaSpitRenderer;
import net.mayaan.client.renderer.entity.MagmaCubeRenderer;
import net.mayaan.client.renderer.entity.MinecartRenderer;
import net.mayaan.client.renderer.entity.MushroomCowRenderer;
import net.mayaan.client.renderer.entity.NautilusRenderer;
import net.mayaan.client.renderer.entity.NoopRenderer;
import net.mayaan.client.renderer.entity.OcelotRenderer;
import net.mayaan.client.renderer.entity.OminousItemSpawnerRenderer;
import net.mayaan.client.renderer.entity.PaintingRenderer;
import net.mayaan.client.renderer.entity.PandaRenderer;
import net.mayaan.client.renderer.entity.ParchedRenderer;
import net.mayaan.client.renderer.entity.ParrotRenderer;
import net.mayaan.client.renderer.entity.PhantomRenderer;
import net.mayaan.client.renderer.entity.PigRenderer;
import net.mayaan.client.renderer.entity.PiglinRenderer;
import net.mayaan.client.renderer.entity.PillagerRenderer;
import net.mayaan.client.renderer.entity.PolarBearRenderer;
import net.mayaan.client.renderer.entity.PufferfishRenderer;
import net.mayaan.client.renderer.entity.RabbitRenderer;
import net.mayaan.client.renderer.entity.RaftRenderer;
import net.mayaan.client.renderer.entity.RavagerRenderer;
import net.mayaan.client.renderer.entity.SalmonRenderer;
import net.mayaan.client.renderer.entity.SheepRenderer;
import net.mayaan.client.renderer.entity.ShulkerBulletRenderer;
import net.mayaan.client.renderer.entity.ShulkerRenderer;
import net.mayaan.client.renderer.entity.SilverfishRenderer;
import net.mayaan.client.renderer.entity.SkeletonRenderer;
import net.mayaan.client.renderer.entity.SlimeRenderer;
import net.mayaan.client.renderer.entity.SnifferRenderer;
import net.mayaan.client.renderer.entity.SnowGolemRenderer;
import net.mayaan.client.renderer.entity.SpectralArrowRenderer;
import net.mayaan.client.renderer.entity.SpiderRenderer;
import net.mayaan.client.renderer.entity.SquidRenderer;
import net.mayaan.client.renderer.entity.StrayRenderer;
import net.mayaan.client.renderer.entity.StriderRenderer;
import net.mayaan.client.renderer.entity.TadpoleRenderer;
import net.mayaan.client.renderer.entity.ThrownItemRenderer;
import net.mayaan.client.renderer.entity.ThrownTridentRenderer;
...
import net.mayaan.client.renderer.entity.TntRenderer;
import net.mayaan.client.renderer.entity.TropicalFishRenderer;
import net.mayaan.client.renderer.entity.TurtleRenderer;
import net.mayaan.client.renderer.entity.UndeadHorseRenderer;
import net.mayaan.client.renderer.entity.VexRenderer;
import net.mayaan.client.renderer.entity.VillagerRenderer;
import net.mayaan.client.renderer.entity.VindicatorRenderer;
import net.mayaan.client.renderer.entity.WanderingTraderRenderer;
import net.mayaan.client.renderer.entity.WardenRenderer;
import net.mayaan.client.renderer.entity.WindChargeRenderer;
import net.mayaan.client.renderer.entity.WitchRenderer;
import net.mayaan.client.renderer.entity.WitherBossRenderer;
import net.mayaan.client.renderer.entity.WitherSkeletonRenderer;
import net.mayaan.client.renderer.entity.WitherSkullRenderer;
import net.mayaan.client.renderer.entity.WolfRenderer;
import net.mayaan.client.renderer.entity.ZoglinRenderer;
import net.mayaan.client.renderer.entity.ZombieNautilusRenderer;
import net.mayaan.client.renderer.entity.ZombieRenderer;
import net.mayaan.client.renderer.entity.ZombieVillagerRenderer;
import net.mayaan.client.renderer.entity.ZombifiedPiglinRenderer;
import net.mayaan.client.renderer.entity.player.AvatarRenderer;
