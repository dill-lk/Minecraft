...
import net.mayaan.client.model.animal.fish.TropicalFishLargeModel;
import net.mayaan.client.model.animal.fish.TropicalFishSmallModel;
import net.mayaan.client.model.geom.ModelLayers;
import net.mayaan.client.renderer.SubmitNodeCollector;
import net.mayaan.client.renderer.entity.EntityRendererProvider;
import net.mayaan.client.renderer.entity.MobRenderer;
import net.mayaan.client.renderer.entity.layers.TropicalFishPatternLayer;
