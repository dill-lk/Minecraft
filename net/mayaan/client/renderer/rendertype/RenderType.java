...
import net.mayaan.client.renderer.rendertype.RenderSetup;
...
public class RenderType {
    ...
    public void draw(MeshData mesh) {
        ...
        GpuBufferSlice dynamicTransforms = RenderSystem.getDynamicUniforms().writeTransform((Matrix4fc)RenderSystem.getModelViewMatrix(), (Vector4fc)new Vector4f(1.0f, 1.0f, 1.0f, 1.0f), (Vector3fc)new Vector3f(), (Matrix4fc)this.state.textureTransform.getMatrix());
