...
import net.mayaan.world.level.levelgen.structure.structures.BuriedTreasureStructure;
import net.mayaan.world.level.levelgen.structure.structures.DesertPyramidStructure;
import net.mayaan.world.level.levelgen.structure.structures.EndCityStructure;
import net.mayaan.world.level.levelgen.structure.structures.IglooStructure;
import net.mayaan.world.level.levelgen.structure.structures.JigsawStructure;
import net.mayaan.world.level.levelgen.structure.structures.JungleTempleStructure;
...
import net.mayaan.world.level.levelgen.structure.structures.NetherFossilStructure;
import net.mayaan.world.level.levelgen.structure.structures.OceanMonumentStructure;
import net.mayaan.world.level.levelgen.structure.structures.OceanRuinStructure;
import net.mayaan.world.level.levelgen.structure.structures.RuinedPortalPiece;
import net.mayaan.world.level.levelgen.structure.structures.RuinedPortalStructure;
import net.mayaan.world.level.levelgen.structure.structures.ShipwreckStructure;
import net.mayaan.world.level.levelgen.structure.structures.StrongholdStructure;
import net.mayaan.world.level.levelgen.structure.structures.SwampHutStructure;
import net.mayaan.world.level.levelgen.structure.structures.WoodlandMansionStructure;
