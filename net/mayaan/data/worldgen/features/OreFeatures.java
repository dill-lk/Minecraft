...
public class OreFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        TagMatchTest naturalStone = new TagMatchTest(BlockTags.BASE_STONE_OVERWORLD);
        ...
        BlockMatchTest netherrack = new BlockMatchTest(Blocks.NETHERRACK);
        TagMatchTest netherOreReplaceables = new TagMatchTest(BlockTags.BASE_STONE_NETHER);
