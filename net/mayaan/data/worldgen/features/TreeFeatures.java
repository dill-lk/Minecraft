...
import net.mayaan.world.level.levelgen.feature.foliageplacers.AcaciaFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.BlobFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.BushFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.CherryFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.DarkOakFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.FancyFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.MegaJungleFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.MegaPineFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.PineFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.RandomSpreadFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.foliageplacers.SpruceFoliagePlacer;
import net.mayaan.world.level.levelgen.feature.rootplacers.AboveRootPlacement;
import net.mayaan.world.level.levelgen.feature.rootplacers.MangroveRootPlacement;
import net.mayaan.world.level.levelgen.feature.rootplacers.MangroveRootPlacer;
import net.mayaan.world.level.levelgen.feature.stateproviders.BlockStateProvider;
import net.mayaan.world.level.levelgen.feature.stateproviders.RandomizedIntStateProvider;
import net.mayaan.world.level.levelgen.feature.stateproviders.RuleBasedStateProvider;
import net.mayaan.world.level.levelgen.feature.stateproviders.WeightedStateProvider;
...
public class TreeFeatures {
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        FeatureUtils.register(context, DARK_OAK, Feature.TREE, TreeFeatures.createDarkOak().ignoreVines().build());
        FeatureUtils.register(context, PALE_OAK, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.PALE_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.PALE_OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty())).decorators((List<TreeDecorator>)ImmutableList.of((Object)new PaleMossDecorator(0.15f, 0.4f, 0.8f))).ignoreVines().build());
        ...
        FeatureUtils.register(context, PALE_OAK_CREAKING, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.PALE_OAK_LOG), new DarkOakTrunkPlacer(6, 2, 1), BlockStateProvider.simple(Blocks.PALE_OAK_LEAVES), new DarkOakFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0)), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty())).decorators((List<TreeDecorator>)ImmutableList.of((Object)new PaleMossDecorator(0.15f, 0.4f, 0.8f), (Object)new CreakingHeartDecorator(1.0f))).ignoreVines().build());
        FeatureUtils.register(context, BIRCH, Feature.TREE, TreeFeatures.createBirch().build());
        ...
        FeatureUtils.register(context, CHERRY, Feature.TREE, TreeFeatures.cherry().build());
        FeatureUtils.register(context, CHERRY_BEES_005, Feature.TREE, TreeFeatures.cherry().decorators(List.of(beehive005)).build());
        ...
        FeatureUtils.register(context, JUNGLE_TREE, Feature.TREE, TreeFeatures.createJungleTree().decorators((List<TreeDecorator>)ImmutableList.of((Object)new CocoaDecorator(0.2f), (Object)TrunkVineDecorator.INSTANCE, (Object)new LeaveVineDecorator(0.25f))).ignoreVines().build());
        FeatureUtils.register(context, FANCY_OAK, Feature.TREE, TreeFeatures.createFancyOak().build());
        FeatureUtils.register(context, JUNGLE_TREE_NO_VINE, Feature.TREE, TreeFeatures.createJungleTree().ignoreVines().build());
        ...
        FeatureUtils.register(context, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createSuperBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)beehive0002)).build());
        FeatureUtils.register(context, SUPER_BIRCH_BEES, Feature.TREE, TreeFeatures.createSuperBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)beehive)).build());
        FeatureUtils.register(context, SWAMP_OAK, Feature.TREE, TreeFeatures.createStraightBlobTree(Blocks.OAK_LOG, Blocks.OAK_LEAVES, 5, 3, 0, 3).decorators((List<TreeDecorator>)ImmutableList.of((Object)new LeaveVineDecorator(0.25f))).build());
        ...
        FeatureUtils.register(context, MANGROVE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(2, 1, 4, UniformInt.of(1, 4), 0.5f, UniformInt.of(0, 1), blocks.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(1, 3), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.5f)), new MangroveRootPlacement(blocks.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2f))), new TwoLayersFeatureSize(2, 0, 2), TreeConfiguration.PLACE_BELOW_OVERWORLD_TRUNKS).decorators(List.of(new LeaveVineDecorator(0.125f), new AttachedToLeavesDecorator(0.14f, 1, 0, new RandomizedIntStateProvider((BlockStateProvider)BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, (IntProvider)UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)), beehive001)).ignoreVines().build());
        FeatureUtils.register(context, TALL_MANGROVE, Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(BlockStateProvider.simple(Blocks.MANGROVE_LOG), new UpwardsBranchingTrunkPlacer(4, 1, 9, UniformInt.of(1, 6), 0.5f, UniformInt.of(0, 1), blocks.getOrThrow(BlockTags.MANGROVE_LOGS_CAN_GROW_THROUGH)), BlockStateProvider.simple(Blocks.MANGROVE_LEAVES), new RandomSpreadFoliagePlacer(ConstantInt.of(3), ConstantInt.of(0), ConstantInt.of(2), 70), Optional.of(new MangroveRootPlacer(UniformInt.of(3, 7), BlockStateProvider.simple(Blocks.MANGROVE_ROOTS), Optional.of(new AboveRootPlacement(BlockStateProvider.simple(Blocks.MOSS_CARPET), 0.5f)), new MangroveRootPlacement(blocks.getOrThrow(BlockTags.MANGROVE_ROOTS_CAN_GROW_THROUGH), HolderSet.direct(Block::builtInRegistryHolder, Blocks.MUD, Blocks.MUDDY_MANGROVE_ROOTS), BlockStateProvider.simple(Blocks.MUDDY_MANGROVE_ROOTS), 8, 15, 0.2f))), new TwoLayersFeatureSize(3, 0, 2), TreeConfiguration.PLACE_BELOW_OVERWORLD_TRUNKS).decorators(List.of(new LeaveVineDecorator(0.125f), new AttachedToLeavesDecorator(0.14f, 1, 0, new RandomizedIntStateProvider((BlockStateProvider)BlockStateProvider.simple((BlockState)Blocks.MANGROVE_PROPAGULE.defaultBlockState().setValue(MangrovePropaguleBlock.HANGING, true)), MangrovePropaguleBlock.AGE, (IntProvider)UniformInt.of(0, 4)), 2, List.of(Direction.DOWN)), beehive001)).ignoreVines().build());
        FeatureUtils.register(context, OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build());
        FeatureUtils.register(context, OAK_BEES_002, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehive002)).build());
        FeatureUtils.register(context, OAK_BEES_005, Feature.TREE, TreeFeatures.createOak().decorators(List.of(beehive005)).build());
        FeatureUtils.register(context, BIRCH_BEES_0002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehive0002)).build());
        FeatureUtils.register(context, BIRCH_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build());
        FeatureUtils.register(context, BIRCH_BEES_002, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehive002)).build());
        FeatureUtils.register(context, BIRCH_BEES_005, Feature.TREE, TreeFeatures.createBirch().decorators(List.of(beehive005)).build());
        FeatureUtils.register(context, FANCY_OAK_BEES_0002_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehive0002, sparseLeafLitter, thickLeafLitter)).build());
        FeatureUtils.register(context, FANCY_OAK_BEES_002, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehive002)).build());
        FeatureUtils.register(context, FANCY_OAK_BEES_005, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehive005)).build());
        FeatureUtils.register(context, FANCY_OAK_BEES, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(beehive)).build());
        FeatureUtils.register(context, OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createOak().decorators((List<TreeDecorator>)ImmutableList.of((Object)sparseLeafLitter, (Object)thickLeafLitter)).build());
        FeatureUtils.register(context, DARK_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createDarkOak().ignoreVines().decorators((List<TreeDecorator>)ImmutableList.of((Object)sparseLeafLitter, (Object)thickLeafLitter)).build());
        FeatureUtils.register(context, BIRCH_LEAF_LITTER, Feature.TREE, TreeFeatures.createBirch().decorators((List<TreeDecorator>)ImmutableList.of((Object)sparseLeafLitter, (Object)thickLeafLitter)).build());
        FeatureUtils.register(context, FANCY_OAK_LEAF_LITTER, Feature.TREE, TreeFeatures.createFancyOak().decorators(List.of(sparseLeafLitter, thickLeafLitter)).build());
