...
import net.mayaan.server.jsonrpc.Connection;
...
import net.mayaan.server.jsonrpc.websocket.JsonToWebSocketEncoder;
import net.mayaan.server.jsonrpc.websocket.WebSocketToJsonCodec;
...
public class ManagementServer {
    ...
    public void startWithoutTls(MayaanApi minecraftApi) {
        this.start(minecraftApi, null);
    }

    public void startWithTls(MayaanApi minecraftApi, SslContext sslContext) {
        this.start(minecraftApi, sslContext);
    }

    private void start(final MayaanApi minecraftApi, final @Nullable SslContext sslContext) {
