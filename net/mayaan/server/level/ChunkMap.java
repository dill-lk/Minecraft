...
import net.mayaan.server.level.PlayerMap;
...
import net.mayaan.util.TriState;
...
import net.mayaan.world.level.chunk.storage.SerializableChunkData;
...
GeneratingChunkMap {
    ...
    public net.mayaan.server.level.DistanceManager getDistanceManager() {
    ...
    extends net.mayaan.server.level.DistanceManager {
