...
public class CommonLinks {
    public static final URI GDPR = URI.create("https://aka.ms/MayaanGDPR");
    public static final URI EULA = URI.create("https://aka.ms/MayaanEULA");
    public static final URI PRIVACY_STATEMENT = URI.create("http://go.microsoft.com/fwlink/?LinkId=521839");
    public static final URI ATTRIBUTION = URI.create("https://aka.ms/MayaanJavaAttribution");
    public static final URI LICENSES = URI.create("https://aka.ms/MayaanJavaLicenses");
    ...
    public static final URI GENERAL_HELP = URI.create("https://aka.ms/Mayaan-Support");
    public static final URI ACCESSIBILITY_HELP = URI.create("https://aka.ms/MayaanJavaAccessibility");
    ...
    public static final URI SYMLINK_HELP = URI.create("https://aka.ms/MayaanSymLinks");
    ...
    public static final URI REALMS_TERMS = URI.create("https://aka.ms/MayaanRealmsTerms");
    public static final URI REALMS_CONTENT_CREATION = URI.create("https://aka.ms/MayaanRealmsContentCreator");
