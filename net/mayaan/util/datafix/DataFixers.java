...
import net.mayaan.util.datafix.fixes.AbstractArrowPickupFix;
import net.mayaan.util.datafix.fixes.AddFieldFix;
import net.mayaan.util.datafix.fixes.AddFlagIfNotPresentFix;
import net.mayaan.util.datafix.fixes.AddNewChoices;
import net.mayaan.util.datafix.fixes.AdvancementsFix;
import net.mayaan.util.datafix.fixes.AdvancementsRenameFix;
import net.mayaan.util.datafix.fixes.AreaEffectCloudDurationScaleFix;
import net.mayaan.util.datafix.fixes.AreaEffectCloudPotionFix;
import net.mayaan.util.datafix.fixes.AttributeIdPrefixFix;
import net.mayaan.util.datafix.fixes.AttributeModifierIdFix;
import net.mayaan.util.datafix.fixes.AttributesRenameLegacy;
import net.mayaan.util.datafix.fixes.BannerEntityCustomNameToOverrideComponentFix;
import net.mayaan.util.datafix.fixes.BannerPatternFormatFix;
import net.mayaan.util.datafix.fixes.BedItemColorFix;
import net.mayaan.util.datafix.fixes.BeehiveFieldRenameFix;
import net.mayaan.util.datafix.fixes.BiomeFix;
import net.mayaan.util.datafix.fixes.BitStorageAlignFix;
import net.mayaan.util.datafix.fixes.BlendingDataFix;
import net.mayaan.util.datafix.fixes.BlendingDataRemoveFromNetherEndFix;
import net.mayaan.util.datafix.fixes.BlockEntityBannerColorFix;
import net.mayaan.util.datafix.fixes.BlockEntityBlockStateFix;
import net.mayaan.util.datafix.fixes.BlockEntityCustomNameToComponentFix;
import net.mayaan.util.datafix.fixes.BlockEntityFurnaceBurnTimeFix;
import net.mayaan.util.datafix.fixes.BlockEntityIdFix;
import net.mayaan.util.datafix.fixes.BlockEntityJukeboxFix;
import net.mayaan.util.datafix.fixes.BlockEntityKeepPacked;
import net.mayaan.util.datafix.fixes.BlockEntityRenameFix;
import net.mayaan.util.datafix.fixes.BlockEntityShulkerBoxColorFix;
import net.mayaan.util.datafix.fixes.BlockEntitySignDoubleSidedEditableTextFix;
import net.mayaan.util.datafix.fixes.BlockEntityUUIDFix;
import net.mayaan.util.datafix.fixes.BlockNameFlatteningFix;
import net.mayaan.util.datafix.fixes.BlockPosFormatAndRenamesFix;
import net.mayaan.util.datafix.fixes.BlockPropertyRenameAndFix;
import net.mayaan.util.datafix.fixes.BlockRenameFix;
import net.mayaan.util.datafix.fixes.BlockStateStructureTemplateFix;
import net.mayaan.util.datafix.fixes.BoatSplitFix;
import net.mayaan.util.datafix.fixes.CarvingStepRemoveFix;
import net.mayaan.util.datafix.fixes.CatTypeFix;
import net.mayaan.util.datafix.fixes.CauldronRenameFix;
import net.mayaan.util.datafix.fixes.CavesAndCliffsRenames;
import net.mayaan.util.datafix.fixes.ChestedHorsesInventoryZeroIndexingFix;
import net.mayaan.util.datafix.fixes.ChunkBedBlockEntityInjecterFix;
import net.mayaan.util.datafix.fixes.ChunkBiomeFix;
import net.mayaan.util.datafix.fixes.ChunkDeleteIgnoredLightDataFix;
import net.mayaan.util.datafix.fixes.ChunkDeleteLightFix;
import net.mayaan.util.datafix.fixes.ChunkHeightAndBiomeFix;
import net.mayaan.util.datafix.fixes.ChunkLightRemoveFix;
import net.mayaan.util.datafix.fixes.ChunkPalettedStorageFix;
import net.mayaan.util.datafix.fixes.ChunkProtoTickListFix;
import net.mayaan.util.datafix.fixes.ChunkRenamesFix;
import net.mayaan.util.datafix.fixes.ChunkStatusFix;
import net.mayaan.util.datafix.fixes.ChunkStatusFix2;
import net.mayaan.util.datafix.fixes.ChunkStructuresTemplateRenameFix;
import net.mayaan.util.datafix.fixes.ChunkTicketUnpackPosFix;
import net.mayaan.util.datafix.fixes.ChunkToProtochunkFix;
import net.mayaan.util.datafix.fixes.ColorlessShulkerEntityFix;
import net.mayaan.util.datafix.fixes.ContainerBlockEntityLockPredicateFix;
import net.mayaan.util.datafix.fixes.CopperGolemWeatherStateFix;
import net.mayaan.util.datafix.fixes.CriteriaRenameFix;
import net.mayaan.util.datafix.fixes.CustomModelDataExpandFix;
import net.mayaan.util.datafix.fixes.DayTimeToClockFix;
import net.mayaan.util.datafix.fixes.DebugProfileLookingAtSplitFix;
import net.mayaan.util.datafix.fixes.DebugProfileOverlayReferenceFix;
import net.mayaan.util.datafix.fixes.DecoratedPotFieldRenameFix;
import net.mayaan.util.datafix.fixes.DropChancesFormatFix;
import net.mayaan.util.datafix.fixes.DropInvalidSignDataFix;
import net.mayaan.util.datafix.fixes.DyeItemRenameFix;
import net.mayaan.util.datafix.fixes.EffectDurationFix;
import net.mayaan.util.datafix.fixes.EmptyItemInHotbarFix;
import net.mayaan.util.datafix.fixes.EmptyItemInVillagerTradeFix;
import net.mayaan.util.datafix.fixes.EntityArmorStandSilentFix;
import net.mayaan.util.datafix.fixes.EntityAttributeBaseValueFix;
import net.mayaan.util.datafix.fixes.EntityBlockStateFix;
import net.mayaan.util.datafix.fixes.EntityBrushableBlockFieldsRenameFix;
import net.mayaan.util.datafix.fixes.EntityCatSplitFix;
import net.mayaan.util.datafix.fixes.EntityCodSalmonFix;
import net.mayaan.util.datafix.fixes.EntityCustomNameToComponentFix;
import net.mayaan.util.datafix.fixes.EntityElderGuardianSplitFix;
import net.mayaan.util.datafix.fixes.EntityEquipmentToArmorAndHandFix;
import net.mayaan.util.datafix.fixes.EntityFallDistanceFloatToDoubleFix;
import net.mayaan.util.datafix.fixes.EntityFieldsRenameFix;
import net.mayaan.util.datafix.fixes.EntityGoatMissingStateFix;
import net.mayaan.util.datafix.fixes.EntityHealthFix;
import net.mayaan.util.datafix.fixes.EntityHorseSaddleFix;
import net.mayaan.util.datafix.fixes.EntityHorseSplitFix;
import net.mayaan.util.datafix.fixes.EntityIdFix;
import net.mayaan.util.datafix.fixes.EntityItemFrameDirectionFix;
import net.mayaan.util.datafix.fixes.EntityMinecartIdentifiersFix;
import net.mayaan.util.datafix.fixes.EntityPaintingItemFrameDirectionFix;
import net.mayaan.util.datafix.fixes.EntityPaintingMotiveFix;
import net.mayaan.util.datafix.fixes.EntityProjectileOwnerFix;
import net.mayaan.util.datafix.fixes.EntityPufferfishRenameFix;
import net.mayaan.util.datafix.fixes.EntityRavagerRenameFix;
import net.mayaan.util.datafix.fixes.EntityRedundantChanceTagsFix;
import net.mayaan.util.datafix.fixes.EntityRidingToPassengersFix;
import net.mayaan.util.datafix.fixes.EntitySalmonSizeFix;
import net.mayaan.util.datafix.fixes.EntityShulkerColorFix;
import net.mayaan.util.datafix.fixes.EntityShulkerRotationFix;
import net.mayaan.util.datafix.fixes.EntitySkeletonSplitFix;
import net.mayaan.util.datafix.fixes.EntitySpawnerItemVariantComponentFix;
import net.mayaan.util.datafix.fixes.EntityStringUuidFix;
import net.mayaan.util.datafix.fixes.EntityTheRenameningFix;
import net.mayaan.util.datafix.fixes.EntityTippedArrowFix;
import net.mayaan.util.datafix.fixes.EntityUUIDFix;
import net.mayaan.util.datafix.fixes.EntityVariantFix;
import net.mayaan.util.datafix.fixes.EntityWolfColorFix;
import net.mayaan.util.datafix.fixes.EntityZombieSplitFix;
import net.mayaan.util.datafix.fixes.EntityZombieVillagerTypeFix;
import net.mayaan.util.datafix.fixes.EntityZombifiedPiglinRenameFix;
import net.mayaan.util.datafix.fixes.EquipmentFormatFix;
import net.mayaan.util.datafix.fixes.EquippableAssetRenameFix;
import net.mayaan.util.datafix.fixes.FeatureFlagRemoveFix;
import net.mayaan.util.datafix.fixes.FilteredBooksFix;
import net.mayaan.util.datafix.fixes.FilteredSignsFix;
import net.mayaan.util.datafix.fixes.FireResistantToDamageResistantComponentFix;
import net.mayaan.util.datafix.fixes.FixProjectileStoredItem;
import net.mayaan.util.datafix.fixes.FixWolfHealth;
import net.mayaan.util.datafix.fixes.FoodToConsumableFix;
import net.mayaan.util.datafix.fixes.ForcePoiRebuild;
import net.mayaan.util.datafix.fixes.ForcedChunkToTicketFix;
import net.mayaan.util.datafix.fixes.FurnaceRecipeFix;
import net.mayaan.util.datafix.fixes.GameRuleRegistryFix;
import net.mayaan.util.datafix.fixes.GoatHornIdFix;
import net.mayaan.util.datafix.fixes.GossipUUIDFix;
import net.mayaan.util.datafix.fixes.HeightmapRenamingFix;
import net.mayaan.util.datafix.fixes.HorseBodyArmorItemFix;
import net.mayaan.util.datafix.fixes.IglooMetadataRemovalFix;
import net.mayaan.util.datafix.fixes.InlineBlockPosFormatFix;
import net.mayaan.util.datafix.fixes.InvalidBlockEntityLockFix;
import net.mayaan.util.datafix.fixes.InvalidLockComponentFix;
import net.mayaan.util.datafix.fixes.ItemBannerColorFix;
import net.mayaan.util.datafix.fixes.ItemCustomNameToComponentFix;
import net.mayaan.util.datafix.fixes.ItemIdFix;
import net.mayaan.util.datafix.fixes.ItemLoreFix;
import net.mayaan.util.datafix.fixes.ItemPotionFix;
import net.mayaan.util.datafix.fixes.ItemRenameFix;
import net.mayaan.util.datafix.fixes.ItemShulkerBoxColorFix;
import net.mayaan.util.datafix.fixes.ItemSpawnEggFix;
import net.mayaan.util.datafix.fixes.ItemStackComponentizationFix;
import net.mayaan.util.datafix.fixes.ItemStackCustomNameToOverrideComponentFix;
import net.mayaan.util.datafix.fixes.ItemStackEnchantmentNamesFix;
import net.mayaan.util.datafix.fixes.ItemStackMapIdFix;
import net.mayaan.util.datafix.fixes.ItemStackSpawnEggFix;
import net.mayaan.util.datafix.fixes.ItemStackTheFlatteningFix;
import net.mayaan.util.datafix.fixes.ItemStackUUIDFix;
import net.mayaan.util.datafix.fixes.ItemWaterPotionFix;
import net.mayaan.util.datafix.fixes.JigsawPropertiesFix;
import net.mayaan.util.datafix.fixes.JigsawRotationFix;
import net.mayaan.util.datafix.fixes.JukeboxTicksSinceSongStartedFix;
import net.mayaan.util.datafix.fixes.LeavesFix;
import net.mayaan.util.datafix.fixes.LegacyDimensionIdFix;
import net.mayaan.util.datafix.fixes.LegacyDragonFightFix;
import net.mayaan.util.datafix.fixes.LegacyHoverEventFix;
import net.mayaan.util.datafix.fixes.LegacyWorldBorderFix;
import net.mayaan.util.datafix.fixes.LevelDatDifficultyFix;
import net.mayaan.util.datafix.fixes.LevelDatToSavedDataPreparationFix;
import net.mayaan.util.datafix.fixes.LevelDataGeneratorOptionsFix;
import net.mayaan.util.datafix.fixes.LevelFlatGeneratorInfoFix;
import net.mayaan.util.datafix.fixes.LevelLegacyWorldGenSettingsFix;
import net.mayaan.util.datafix.fixes.LevelUUIDFix;
import net.mayaan.util.datafix.fixes.LockComponentPredicateFix;
import net.mayaan.util.datafix.fixes.LodestoneCompassComponentFix;
import net.mayaan.util.datafix.fixes.MapBannerBlockPosFormatFix;
import net.mayaan.util.datafix.fixes.MapIdFix;
import net.mayaan.util.datafix.fixes.MemoryExpiryDataFix;
import net.mayaan.util.datafix.fixes.MissingDimensionFix;
import net.mayaan.util.datafix.fixes.MobEffectIdFix;
import net.mayaan.util.datafix.fixes.MobSpawnerEntityIdentifiersFix;
import net.mayaan.util.datafix.fixes.NamedEntityConvertUncheckedFix;
import net.mayaan.util.datafix.fixes.NamedEntityWriteReadFix;
import net.mayaan.util.datafix.fixes.NamespacedTypeRenameFix;
import net.mayaan.util.datafix.fixes.NewVillageFix;
import net.mayaan.util.datafix.fixes.ObjectiveRenderTypeFix;
import net.mayaan.util.datafix.fixes.OminousBannerBlockEntityRenameFix;
import net.mayaan.util.datafix.fixes.OminousBannerRarityFix;
import net.mayaan.util.datafix.fixes.OminousBannerRenameFix;
import net.mayaan.util.datafix.fixes.OptionsAccessibilityOnboardFix;
import net.mayaan.util.datafix.fixes.OptionsAddTextBackgroundFix;
import net.mayaan.util.datafix.fixes.OptionsAmbientOcclusionFix;
import net.mayaan.util.datafix.fixes.OptionsFancyGraphicsToGraphicsModeFix;
import net.mayaan.util.datafix.fixes.OptionsForceVBOFix;
import net.mayaan.util.datafix.fixes.OptionsGraphicsModeSplitFix;
import net.mayaan.util.datafix.fixes.OptionsKeyLwjgl3Fix;
import net.mayaan.util.datafix.fixes.OptionsKeyTranslationFix;
import net.mayaan.util.datafix.fixes.OptionsLowerCaseLanguageFix;
import net.mayaan.util.datafix.fixes.OptionsMenuBlurrinessFix;
import net.mayaan.util.datafix.fixes.OptionsMusicToastFix;
import net.mayaan.util.datafix.fixes.OptionsProgrammerArtFix;
import net.mayaan.util.datafix.fixes.OptionsRenameFieldFix;
import net.mayaan.util.datafix.fixes.OptionsSetGraphicsPresetToCustomFix;
import net.mayaan.util.datafix.fixes.OverreachingTickFix;
import net.mayaan.util.datafix.fixes.ParticleUnflatteningFix;
import net.mayaan.util.datafix.fixes.PlayerEquipmentFix;
import net.mayaan.util.datafix.fixes.PlayerHeadBlockProfileFix;
import net.mayaan.util.datafix.fixes.PlayerRespawnDataFix;
import net.mayaan.util.datafix.fixes.PlayerUUIDFix;
import net.mayaan.util.datafix.fixes.PoiTypeRemoveFix;
import net.mayaan.util.datafix.fixes.PoiTypeRenameFix;
import net.mayaan.util.datafix.fixes.PrimedTntBlockStateFixer;
import net.mayaan.util.datafix.fixes.ProjectileStoredWeaponFix;
import net.mayaan.util.datafix.fixes.RaidRenamesDataFix;
import net.mayaan.util.datafix.fixes.RandomSequenceSettingsFix;
import net.mayaan.util.datafix.fixes.RecipesFix;
import net.mayaan.util.datafix.fixes.RecipesRenameningFix;
import net.mayaan.util.datafix.fixes.RedstoneWireConnectionsFix;
import net.mayaan.util.datafix.fixes.References;
import net.mayaan.util.datafix.fixes.RemapChunkStatusFix;
import net.mayaan.util.datafix.fixes.RemoveBlockEntityTagFix;
import net.mayaan.util.datafix.fixes.RemoveEmptyItemInBrushableBlockFix;
import net.mayaan.util.datafix.fixes.RemoveGolemGossipFix;
import net.mayaan.util.datafix.fixes.RenameEnchantmentsFix;
import net.mayaan.util.datafix.fixes.RenamedCoralFansFix;
import net.mayaan.util.datafix.fixes.RenamedCoralFix;
import net.mayaan.util.datafix.fixes.ReorganizePoi;
import net.mayaan.util.datafix.fixes.SaddleEquipmentSlotFix;
import net.mayaan.util.datafix.fixes.SavedDataFeaturePoolElementFix;
import net.mayaan.util.datafix.fixes.SavedDataUUIDFix;
import net.mayaan.util.datafix.fixes.ScoreboardDisplayNameFix;
import net.mayaan.util.datafix.fixes.ScoreboardDisplaySlotFix;
import net.mayaan.util.datafix.fixes.SignTextStrictJsonFix;
import net.mayaan.util.datafix.fixes.SpawnerDataFix;
import net.mayaan.util.datafix.fixes.StatsCounterFix;
import net.mayaan.util.datafix.fixes.StatsRenameFix;
import net.mayaan.util.datafix.fixes.StonecutterRecipeRenameFix;
import net.mayaan.util.datafix.fixes.StriderGravityFix;
import net.mayaan.util.datafix.fixes.StructureReferenceCountFix;
import net.mayaan.util.datafix.fixes.StructureSettingsFlattenFix;
import net.mayaan.util.datafix.fixes.StructuresBecomeConfiguredFix;
import net.mayaan.util.datafix.fixes.TextComponentHoverAndClickEventFix;
import net.mayaan.util.datafix.fixes.TextComponentStringifiedFlagsFix;
import net.mayaan.util.datafix.fixes.ThrownPotionSplitFix;
import net.mayaan.util.datafix.fixes.TippedArrowPotionToItemFix;
import net.mayaan.util.datafix.fixes.TooltipDisplayComponentFix;
import net.mayaan.util.datafix.fixes.TrappedChestBlockEntityFix;
import net.mayaan.util.datafix.fixes.TrialSpawnerConfigFix;
import net.mayaan.util.datafix.fixes.TrialSpawnerConfigInRegistryFix;
import net.mayaan.util.datafix.fixes.TridentAnimationFix;
import net.mayaan.util.datafix.fixes.UnflattenTextComponentFix;
import net.mayaan.util.datafix.fixes.VariantRenameFix;
import net.mayaan.util.datafix.fixes.VillagerDataFix;
import net.mayaan.util.datafix.fixes.VillagerFollowRangeFix;
import net.mayaan.util.datafix.fixes.VillagerRebuildLevelAndXpFix;
import net.mayaan.util.datafix.fixes.VillagerSetCanPickUpLootFix;
import net.mayaan.util.datafix.fixes.VillagerSetVillagerDataFinalized;
import net.mayaan.util.datafix.fixes.VillagerTradeFix;
import net.mayaan.util.datafix.fixes.WallPropertyFix;
import net.mayaan.util.datafix.fixes.WeaponSmithChestLootTableFix;
import net.mayaan.util.datafix.fixes.WorldBorderWarningTimeFix;
import net.mayaan.util.datafix.fixes.WorldGenSettingsDisallowOldCustomWorldsFix;
import net.mayaan.util.datafix.fixes.WorldGenSettingsFix;
import net.mayaan.util.datafix.fixes.WorldGenSettingsHeightAndBiomeFix;
import net.mayaan.util.datafix.fixes.WorldSpawnDataFix;
import net.mayaan.util.datafix.fixes.WriteAndReadFix;
import net.mayaan.util.datafix.fixes.WrittenBookPagesStrictJsonFix;
import net.mayaan.util.datafix.fixes.ZombieVillagerRebuildXpFix;
import net.mayaan.util.datafix.fixes.ZombieVillagerSetVillagerDataFinalized;
import net.mayaan.util.datafix.schemas.NamespacedSchema;
import net.mayaan.util.datafix.schemas.V100;
import net.mayaan.util.datafix.schemas.V102;
import net.mayaan.util.datafix.schemas.V1022;
import net.mayaan.util.datafix.schemas.V106;
import net.mayaan.util.datafix.schemas.V107;
import net.mayaan.util.datafix.schemas.V1125;
import net.mayaan.util.datafix.schemas.V135;
import net.mayaan.util.datafix.schemas.V143;
import net.mayaan.util.datafix.schemas.V1451;
import net.mayaan.util.datafix.schemas.V1451_1;
import net.mayaan.util.datafix.schemas.V1451_2;
import net.mayaan.util.datafix.schemas.V1451_3;
import net.mayaan.util.datafix.schemas.V1451_4;
import net.mayaan.util.datafix.schemas.V1451_5;
import net.mayaan.util.datafix.schemas.V1451_6;
import net.mayaan.util.datafix.schemas.V1458;
import net.mayaan.util.datafix.schemas.V1460;
import net.mayaan.util.datafix.schemas.V1466;
import net.mayaan.util.datafix.schemas.V1470;
import net.mayaan.util.datafix.schemas.V1481;
import net.mayaan.util.datafix.schemas.V1483;
import net.mayaan.util.datafix.schemas.V1486;
import net.mayaan.util.datafix.schemas.V1488;
import net.mayaan.util.datafix.schemas.V1510;
import net.mayaan.util.datafix.schemas.V1800;
import net.mayaan.util.datafix.schemas.V1801;
import net.mayaan.util.datafix.schemas.V1904;
import net.mayaan.util.datafix.schemas.V1906;
import net.mayaan.util.datafix.schemas.V1909;
import net.mayaan.util.datafix.schemas.V1920;
import net.mayaan.util.datafix.schemas.V1928;
import net.mayaan.util.datafix.schemas.V1929;
import net.mayaan.util.datafix.schemas.V1931;
import net.mayaan.util.datafix.schemas.V2100;
import net.mayaan.util.datafix.schemas.V2501;
import net.mayaan.util.datafix.schemas.V2502;
import net.mayaan.util.datafix.schemas.V2505;
import net.mayaan.util.datafix.schemas.V2509;
import net.mayaan.util.datafix.schemas.V2511_1;
import net.mayaan.util.datafix.schemas.V2519;
import net.mayaan.util.datafix.schemas.V2522;
import net.mayaan.util.datafix.schemas.V2551;
import net.mayaan.util.datafix.schemas.V2568;
import net.mayaan.util.datafix.schemas.V2571;
import net.mayaan.util.datafix.schemas.V2684;
import net.mayaan.util.datafix.schemas.V2686;
import net.mayaan.util.datafix.schemas.V2688;
import net.mayaan.util.datafix.schemas.V2704;
import net.mayaan.util.datafix.schemas.V2707;
import net.mayaan.util.datafix.schemas.V2831;
import net.mayaan.util.datafix.schemas.V2832;
import net.mayaan.util.datafix.schemas.V2842;
import net.mayaan.util.datafix.schemas.V3076;
import net.mayaan.util.datafix.schemas.V3078;
import net.mayaan.util.datafix.schemas.V3081;
import net.mayaan.util.datafix.schemas.V3082;
import net.mayaan.util.datafix.schemas.V3083;
import net.mayaan.util.datafix.schemas.V3202;
import net.mayaan.util.datafix.schemas.V3203;
import net.mayaan.util.datafix.schemas.V3204;
import net.mayaan.util.datafix.schemas.V3325;
import net.mayaan.util.datafix.schemas.V3326;
import net.mayaan.util.datafix.schemas.V3327;
import net.mayaan.util.datafix.schemas.V3328;
import net.mayaan.util.datafix.schemas.V3438;
import net.mayaan.util.datafix.schemas.V3439;
import net.mayaan.util.datafix.schemas.V3439_1;
import net.mayaan.util.datafix.schemas.V3448;
import net.mayaan.util.datafix.schemas.V3682;
import net.mayaan.util.datafix.schemas.V3683;
import net.mayaan.util.datafix.schemas.V3685;
import net.mayaan.util.datafix.schemas.V3689;
import net.mayaan.util.datafix.schemas.V3799;
import net.mayaan.util.datafix.schemas.V3807;
import net.mayaan.util.datafix.schemas.V3808;
import net.mayaan.util.datafix.schemas.V3808_1;
import net.mayaan.util.datafix.schemas.V3808_2;
import net.mayaan.util.datafix.schemas.V3813;
import net.mayaan.util.datafix.schemas.V3816;
import net.mayaan.util.datafix.schemas.V3818;
import net.mayaan.util.datafix.schemas.V3818_3;
import net.mayaan.util.datafix.schemas.V3818_4;
import net.mayaan.util.datafix.schemas.V3818_5;
import net.mayaan.util.datafix.schemas.V3825;
import net.mayaan.util.datafix.schemas.V3938;
import net.mayaan.util.datafix.schemas.V4059;
import net.mayaan.util.datafix.schemas.V4067;
import net.mayaan.util.datafix.schemas.V4070;
import net.mayaan.util.datafix.schemas.V4071;
import net.mayaan.util.datafix.schemas.V4290;
import net.mayaan.util.datafix.schemas.V4292;
import net.mayaan.util.datafix.schemas.V4300;
import net.mayaan.util.datafix.schemas.V4301;
import net.mayaan.util.datafix.schemas.V4302;
import net.mayaan.util.datafix.schemas.V4306;
import net.mayaan.util.datafix.schemas.V4307;
import net.mayaan.util.datafix.schemas.V4312;
import net.mayaan.util.datafix.schemas.V4420;
import net.mayaan.util.datafix.schemas.V4421;
import net.mayaan.util.datafix.schemas.V4531;
import net.mayaan.util.datafix.schemas.V4532;
import net.mayaan.util.datafix.schemas.V4533;
import net.mayaan.util.datafix.schemas.V4543;
import net.mayaan.util.datafix.schemas.V4648;
import net.mayaan.util.datafix.schemas.V4656;
import net.mayaan.util.datafix.schemas.V4771;
import net.mayaan.util.datafix.schemas.V501;
import net.mayaan.util.datafix.schemas.V700;
import net.mayaan.util.datafix.schemas.V701;
import net.mayaan.util.datafix.schemas.V702;
import net.mayaan.util.datafix.schemas.V703;
import net.mayaan.util.datafix.schemas.V704;
import net.mayaan.util.datafix.schemas.V705;
import net.mayaan.util.datafix.schemas.V808;
import net.mayaan.util.datafix.schemas.V99;
import net.mayaan.util.filefix.FileFixerUpper;
import net.mayaan.util.filefix.fixes.DimensionStorageFileFix;
import net.mayaan.util.filefix.fixes.GeneratedStructuresRenameFileFix;
import net.mayaan.util.filefix.fixes.LegacyStructureFileFix;
import net.mayaan.util.filefix.fixes.LevelDatToSavedDataFileFix;
import net.mayaan.util.filefix.fixes.PlayerStorageFileFix;
import net.mayaan.util.filefix.fixes.RemoveObsoleteFilesFileFix;
import net.mayaan.util.filefix.fixes.ResourcePackLocationFileFix;
