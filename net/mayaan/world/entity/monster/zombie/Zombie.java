...
import net.mayaan.world.entity.ai.goal.MoveThroughVillageGoal;
import net.mayaan.world.entity.ai.goal.RandomLookAroundGoal;
import net.mayaan.world.entity.ai.goal.RemoveBlockGoal;
import net.mayaan.world.entity.ai.goal.SpearUseGoal;
import net.mayaan.world.entity.ai.goal.WaterAvoidingRandomStrollGoal;
import net.mayaan.world.entity.ai.goal.ZombieAttackGoal;
