...
import net.mayaan.world.entity.ai.behavior.VillagerGoalPackages;
import net.mayaan.world.entity.ai.gossip.GossipContainer;
import net.mayaan.world.entity.ai.gossip.GossipType;
...
import net.mayaan.world.entity.npc.villager.VillagerDataHolder;
...
ReputationEventHandler {
    ...
    public void releasePoi(MemoryModuleType<GlobalPos> memoryType) {
        ...
        MayaanServer server = ((ServerLevel)this.level()).getServer();
