...
public class CreativeModeTabs {
    ...
    public static CreativeModeTab bootstrap(Registry<CreativeModeTab> registry) {
        ...
        Registry.register(registry, COLORED_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.coloredBlocks")).icon(() -> new ItemStack(Blocks.CYAN_WOOL)).displayItems((parameters, coloredBlocks) -> {
