...
import net.mayaan.references.ItemIds;
...
import net.mayaan.world.food.Foods;
import net.mayaan.world.item.AirItem;
import net.mayaan.world.item.ArmorStandItem;
import net.mayaan.world.item.ArrowItem;
import net.mayaan.world.item.AxeItem;
import net.mayaan.world.item.BannerItem;
import net.mayaan.world.item.BedItem;
import net.mayaan.world.item.BlockItem;
import net.mayaan.world.item.BoatItem;
import net.mayaan.world.item.BoneMealItem;
import net.mayaan.world.item.BottleItem;
import net.mayaan.world.item.BowItem;
import net.mayaan.world.item.BrushItem;
import net.mayaan.world.item.BucketItem;
import net.mayaan.world.item.BundleItem;
import net.mayaan.world.item.CompassItem;
import net.mayaan.world.item.CrossbowItem;
import net.mayaan.world.item.DebugStickItem;
import net.mayaan.world.item.DiscFragmentItem;
import net.mayaan.world.item.DoubleHighBlockItem;
import net.mayaan.world.item.DyeColor;
import net.mayaan.world.item.DyeItem;
import net.mayaan.world.item.EggItem;
import net.mayaan.world.item.EmptyMapItem;
import net.mayaan.world.item.EndCrystalItem;
import net.mayaan.world.item.EnderEyeItem;
import net.mayaan.world.item.EnderpearlItem;
import net.mayaan.world.item.ExperienceBottleItem;
import net.mayaan.world.item.FireChargeItem;
import net.mayaan.world.item.FireworkRocketItem;
import net.mayaan.world.item.FishingRodItem;
import net.mayaan.world.item.FlintAndSteelItem;
import net.mayaan.world.item.FoodOnAStickItem;
import net.mayaan.world.item.GameMasterBlockItem;
import net.mayaan.world.item.GlowInkSacItem;
import net.mayaan.world.item.HangingEntityItem;
import net.mayaan.world.item.HangingSignItem;
import net.mayaan.world.item.HoeItem;
import net.mayaan.world.item.HoneycombItem;
import net.mayaan.world.item.InkSacItem;
import net.mayaan.world.item.InstrumentItem;
import net.mayaan.world.item.Instruments;
import net.mayaan.world.item.Item;
import net.mayaan.world.item.ItemFrameItem;
import net.mayaan.world.item.JukeboxSongs;
import net.mayaan.world.item.KnowledgeBookItem;
import net.mayaan.world.item.LeadItem;
import net.mayaan.world.item.LingeringPotionItem;
import net.mayaan.world.item.MaceItem;
import net.mayaan.world.item.MapItem;
import net.mayaan.world.item.MinecartItem;
import net.mayaan.world.item.MobBucketItem;
import net.mayaan.world.item.NameTagItem;
import net.mayaan.world.item.PlaceOnWaterBlockItem;
import net.mayaan.world.item.PlayerHeadItem;
import net.mayaan.world.item.PotionItem;
import net.mayaan.world.item.Rarity;
import net.mayaan.world.item.ScaffoldingBlockItem;
import net.mayaan.world.item.ShearsItem;
import net.mayaan.world.item.ShieldItem;
import net.mayaan.world.item.ShovelItem;
import net.mayaan.world.item.SignItem;
import net.mayaan.world.item.SmithingTemplateItem;
import net.mayaan.world.item.SnowballItem;
import net.mayaan.world.item.SolidBucketItem;
import net.mayaan.world.item.SpawnEggItem;
import net.mayaan.world.item.SpectralArrowItem;
import net.mayaan.world.item.SplashPotionItem;
import net.mayaan.world.item.SpyglassItem;
import net.mayaan.world.item.StandingAndWallBlockItem;
import net.mayaan.world.item.TippedArrowItem;
import net.mayaan.world.item.ToolMaterial;
import net.mayaan.world.item.TridentItem;
import net.mayaan.world.item.WeatheringCopperItems;
import net.mayaan.world.item.WindChargeItem;
import net.mayaan.world.item.WritableBookItem;
import net.mayaan.world.item.WrittenBookItem;
...
import net.mayaan.world.item.equipment.ArmorMaterials;
...
public class Items {
    ...
    public static final Item GOLDEN_DANDELION = Items.registerBlock(Blocks.GOLDEN_DANDELION);
    ...
    public static final Item ACACIA_SHELF = Items.registerBlock(Blocks.ACACIA_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BAMBOO_SHELF = Items.registerBlock(Blocks.BAMBOO_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BIRCH_SHELF = Items.registerBlock(Blocks.BIRCH_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CHERRY_SHELF = Items.registerBlock(Blocks.CHERRY_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item CRIMSON_SHELF = Items.registerBlock(Blocks.CRIMSON_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DARK_OAK_SHELF = Items.registerBlock(Blocks.DARK_OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item JUNGLE_SHELF = Items.registerBlock(Blocks.JUNGLE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item MANGROVE_SHELF = Items.registerBlock(Blocks.MANGROVE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item OAK_SHELF = Items.registerBlock(Blocks.OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item PALE_OAK_SHELF = Items.registerBlock(Blocks.PALE_OAK_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SPRUCE_SHELF = Items.registerBlock(Blocks.SPRUCE_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item WARPED_SHELF = Items.registerBlock(Blocks.WARPED_SHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BOOKSHELF = Items.registerBlock(Blocks.BOOKSHELF);
    public static final Item CHISELED_BOOKSHELF = Items.registerBlock(Blocks.CHISELED_BOOKSHELF, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item TORCH = Items.registerBlock(Blocks.TORCH, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.WALL_TORCH, Direction.DOWN, (Item.Properties)p));
    ...
    public static final Item CHEST = Items.registerBlock(Blocks.CHEST, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item FURNACE = Items.registerBlock(Blocks.FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item CARVED_PUMPKIN = Items.registerBlock(Blocks.CARVED_PUMPKIN, p -> Waypoint.addHideAttribute(p).component(DataComponents.EQUIPPABLE, Equippable.builder(EquipmentSlot.HEAD).setSwappable(false).setCameraOverlay(Identifier.withDefaultNamespace("misc/pumpkinblur")).build()));
    ...
    public static final Item SOUL_TORCH = Items.registerBlock(Blocks.SOUL_TORCH, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.SOUL_WALL_TORCH, Direction.DOWN, (Item.Properties)p));
    public static final Item COPPER_TORCH = Items.registerBlock(Blocks.COPPER_TORCH, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.COPPER_WALL_TORCH, Direction.DOWN, (Item.Properties)p));
    ...
    public static final Item IRON_CHAIN = Items.registerBlock(Blocks.IRON_CHAIN);
    ...
    public static final Item LIGHT = Items.registerBlock(Blocks.LIGHT, p -> p.rarity(Rarity.EPIC).component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(LightBlock.LEVEL, 15)));
    public static final Item HAY_BLOCK = Items.registerBlock(Blocks.HAY_BLOCK);
    public static final Item WHITE_CARPET = Items.registerBlock(Blocks.WHITE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE)));
    public static final Item ORANGE_CARPET = Items.registerBlock(Blocks.ORANGE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE)));
    public static final Item MAGENTA_CARPET = Items.registerBlock(Blocks.MAGENTA_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA)));
    public static final Item LIGHT_BLUE_CARPET = Items.registerBlock(Blocks.LIGHT_BLUE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE)));
    public static final Item YELLOW_CARPET = Items.registerBlock(Blocks.YELLOW_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW)));
    public static final Item LIME_CARPET = Items.registerBlock(Blocks.LIME_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME)));
    public static final Item PINK_CARPET = Items.registerBlock(Blocks.PINK_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK)));
    public static final Item GRAY_CARPET = Items.registerBlock(Blocks.GRAY_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY)));
    public static final Item LIGHT_GRAY_CARPET = Items.registerBlock(Blocks.LIGHT_GRAY_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY)));
    public static final Item CYAN_CARPET = Items.registerBlock(Blocks.CYAN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN)));
    public static final Item PURPLE_CARPET = Items.registerBlock(Blocks.PURPLE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE)));
    public static final Item BLUE_CARPET = Items.registerBlock(Blocks.BLUE_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE)));
    public static final Item BROWN_CARPET = Items.registerBlock(Blocks.BROWN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN)));
    public static final Item GREEN_CARPET = Items.registerBlock(Blocks.GREEN_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN)));
    public static final Item RED_CARPET = Items.registerBlock(Blocks.RED_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)));
    public static final Item BLACK_CARPET = Items.registerBlock(Blocks.BLACK_CARPET, p -> p.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK)));
    ...
    public static final Item SNIFFER_EGG = Items.registerBlock(Blocks.SNIFFER_EGG, p -> p.rarity(Rarity.UNCOMMON));
    ...
    public static final Item TUBE_CORAL_FAN = Items.registerBlock(Blocks.TUBE_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item BRAIN_CORAL_FAN = Items.registerBlock(Blocks.BRAIN_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item BUBBLE_CORAL_FAN = Items.registerBlock(Blocks.BUBBLE_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item FIRE_CORAL_FAN = Items.registerBlock(Blocks.FIRE_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item HORN_CORAL_FAN = Items.registerBlock(Blocks.HORN_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item DEAD_TUBE_CORAL_FAN = Items.registerBlock(Blocks.DEAD_TUBE_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item DEAD_BRAIN_CORAL_FAN = Items.registerBlock(Blocks.DEAD_BRAIN_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item DEAD_BUBBLE_CORAL_FAN = Items.registerBlock(Blocks.DEAD_BUBBLE_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item DEAD_FIRE_CORAL_FAN = Items.registerBlock(Blocks.DEAD_FIRE_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    public static final Item DEAD_HORN_CORAL_FAN = Items.registerBlock(Blocks.DEAD_HORN_CORAL_FAN, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, (Item.Properties)p));
    ...
    public static final Item REDSTONE_TORCH = Items.registerBlock(Blocks.REDSTONE_TORCH, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, (Item.Properties)p));
    ...
    public static final Item HOPPER = Items.registerBlock(Blocks.HOPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DISPENSER = Items.registerBlock(Blocks.DISPENSER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item DROPPER = Items.registerBlock(Blocks.DROPPER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item EXPOSED_LIGHTNING_ROD = Items.registerBlock(Blocks.EXPOSED_LIGHTNING_ROD);
    public static final Item WEATHERED_LIGHTNING_ROD = Items.registerBlock(Blocks.WEATHERED_LIGHTNING_ROD);
    public static final Item OXIDIZED_LIGHTNING_ROD = Items.registerBlock(Blocks.OXIDIZED_LIGHTNING_ROD);
    public static final Item WAXED_LIGHTNING_ROD = Items.registerBlock(Blocks.WAXED_LIGHTNING_ROD);
    public static final Item WAXED_EXPOSED_LIGHTNING_ROD = Items.registerBlock(Blocks.WAXED_EXPOSED_LIGHTNING_ROD);
    public static final Item WAXED_WEATHERED_LIGHTNING_ROD = Items.registerBlock(Blocks.WAXED_WEATHERED_LIGHTNING_ROD);
    public static final Item WAXED_OXIDIZED_LIGHTNING_ROD = Items.registerBlock(Blocks.WAXED_OXIDIZED_LIGHTNING_ROD);
    ...
    public static final Item TRAPPED_CHEST = Items.registerBlock(Blocks.TRAPPED_CHEST, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item MINECART = Items.registerItem("minecart", (Item.Properties p) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.MINECART, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item CHEST_MINECART = Items.registerItem("chest_minecart", (Item.Properties p) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.CHEST_MINECART, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item FURNACE_MINECART = Items.registerItem("furnace_minecart", (Item.Properties p) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.FURNACE_MINECART, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item TNT_MINECART = Items.registerItem("tnt_minecart", (Item.Properties p) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.TNT_MINECART, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item HOPPER_MINECART = Items.registerItem("hopper_minecart", (Item.Properties p) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.HOPPER_MINECART, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item CARROT_ON_A_STICK = Items.registerItem("carrot_on_a_stick", (Item.Properties p) -> new FoodOnAStickItem<Pig>(EntityType.PIG, 7, (Item.Properties)p), new Item.Properties().durability(25));
    public static final Item WARPED_FUNGUS_ON_A_STICK = Items.registerItem("warped_fungus_on_a_stick", (Item.Properties p) -> new FoodOnAStickItem<Strider>(EntityType.STRIDER, 1, (Item.Properties)p), new Item.Properties().durability(100));
    ...
    public static final Item OAK_BOAT = Items.registerItem("oak_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.OAK_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item OAK_CHEST_BOAT = Items.registerItem("oak_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.OAK_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item SPRUCE_BOAT = Items.registerItem("spruce_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.SPRUCE_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item SPRUCE_CHEST_BOAT = Items.registerItem("spruce_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.SPRUCE_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item BIRCH_BOAT = Items.registerItem("birch_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BIRCH_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item BIRCH_CHEST_BOAT = Items.registerItem("birch_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BIRCH_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item JUNGLE_BOAT = Items.registerItem("jungle_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.JUNGLE_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item JUNGLE_CHEST_BOAT = Items.registerItem("jungle_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.JUNGLE_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item ACACIA_BOAT = Items.registerItem("acacia_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.ACACIA_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item ACACIA_CHEST_BOAT = Items.registerItem("acacia_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.ACACIA_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item CHERRY_BOAT = Items.registerItem("cherry_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.CHERRY_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item CHERRY_CHEST_BOAT = Items.registerItem("cherry_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.CHERRY_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item DARK_OAK_BOAT = Items.registerItem("dark_oak_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.DARK_OAK_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item DARK_OAK_CHEST_BOAT = Items.registerItem("dark_oak_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.DARK_OAK_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item PALE_OAK_BOAT = Items.registerItem("pale_oak_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.PALE_OAK_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item PALE_OAK_CHEST_BOAT = Items.registerItem("pale_oak_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.PALE_OAK_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item MANGROVE_BOAT = Items.registerItem("mangrove_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.MANGROVE_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item MANGROVE_CHEST_BOAT = Items.registerItem("mangrove_chest_boat", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.MANGROVE_CHEST_BOAT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item BAMBOO_RAFT = Items.registerItem("bamboo_raft", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BAMBOO_RAFT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    public static final Item BAMBOO_CHEST_RAFT = Items.registerItem("bamboo_chest_raft", (Item.Properties p) -> new BoatItem((EntityType<? extends AbstractBoat>)EntityType.BAMBOO_CHEST_RAFT, (Item.Properties)p), new Item.Properties().stacksTo(1));
    ...
    public static final Item WOODEN_SHOVEL = Items.registerItem("wooden_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.WOOD, 1.5f, -3.0f, (Item.Properties)p));
    ...
    public static final Item WOODEN_AXE = Items.registerItem("wooden_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.WOOD, 6.0f, -3.2f, (Item.Properties)p));
    public static final Item WOODEN_HOE = Items.registerItem("wooden_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.WOOD, 0.0f, -3.0f, (Item.Properties)p));
    public static final Item COPPER_SWORD = Items.registerItem("copper_sword", new Item.Properties().sword(ToolMaterial.COPPER, 3.0f, -2.4f));
    public static final Item COPPER_SHOVEL = Items.registerItem("copper_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.COPPER, 1.5f, -3.0f, (Item.Properties)p));
    public static final Item COPPER_PICKAXE = Items.registerItem("copper_pickaxe", new Item.Properties().pickaxe(ToolMaterial.COPPER, 1.0f, -2.8f));
    public static final Item COPPER_AXE = Items.registerItem("copper_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.COPPER, 7.0f, -3.2f, (Item.Properties)p));
    public static final Item COPPER_HOE = Items.registerItem("copper_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.COPPER, -1.0f, -2.0f, (Item.Properties)p));
    ...
    public static final Item STONE_SHOVEL = Items.registerItem("stone_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.STONE, 1.5f, -3.0f, (Item.Properties)p));
    ...
    public static final Item STONE_AXE = Items.registerItem("stone_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.STONE, 7.0f, -3.2f, (Item.Properties)p));
    public static final Item STONE_HOE = Items.registerItem("stone_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.STONE, -1.0f, -2.0f, (Item.Properties)p));
    ...
    public static final Item GOLDEN_SHOVEL = Items.registerItem("golden_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.GOLD, 1.5f, -3.0f, (Item.Properties)p));
    ...
    public static final Item GOLDEN_AXE = Items.registerItem("golden_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.GOLD, 6.0f, -3.0f, (Item.Properties)p));
    public static final Item GOLDEN_HOE = Items.registerItem("golden_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.GOLD, 0.0f, -3.0f, (Item.Properties)p));
    public static final Item IRON_SWORD = Items.registerItem("iron_sword", new Item.Properties().sword(ToolMaterial.IRON, 3.0f, -2.4f));
    public static final Item IRON_SHOVEL = Items.registerItem("iron_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.IRON, 1.5f, -3.0f, (Item.Properties)p));
    ...
    public static final Item IRON_AXE = Items.registerItem("iron_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.IRON, 6.0f, -3.1f, (Item.Properties)p));
    public static final Item IRON_HOE = Items.registerItem("iron_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.IRON, -2.0f, -1.0f, (Item.Properties)p));
    ...
    public static final Item DIAMOND_SHOVEL = Items.registerItem("diamond_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.DIAMOND, 1.5f, -3.0f, (Item.Properties)p));
    ...
    public static final Item DIAMOND_AXE = Items.registerItem("diamond_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.DIAMOND, 5.0f, -3.0f, (Item.Properties)p));
    public static final Item DIAMOND_HOE = Items.registerItem("diamond_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.DIAMOND, -3.0f, 0.0f, (Item.Properties)p));
    ...
    public static final Item NETHERITE_SHOVEL = Items.registerItem("netherite_shovel", (Item.Properties p) -> new ShovelItem(ToolMaterial.NETHERITE, 1.5f, -3.0f, (Item.Properties)p), new Item.Properties().fireResistant());
    ...
    public static final Item NETHERITE_AXE = Items.registerItem("netherite_axe", (Item.Properties p) -> new AxeItem(ToolMaterial.NETHERITE, 5.0f, -3.0f, (Item.Properties)p), new Item.Properties().fireResistant());
    public static final Item NETHERITE_HOE = Items.registerItem("netherite_hoe", (Item.Properties p) -> new HoeItem(ToolMaterial.NETHERITE, -4.0f, 0.0f, (Item.Properties)p), new Item.Properties().fireResistant());
    ...
    public static final Item COPPER_HELMET = Items.registerItem("copper_helmet", new Item.Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.HELMET));
    public static final Item COPPER_CHESTPLATE = Items.registerItem("copper_chestplate", new Item.Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.CHESTPLATE));
    public static final Item COPPER_LEGGINGS = Items.registerItem("copper_leggings", new Item.Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.LEGGINGS));
    public static final Item COPPER_BOOTS = Items.registerItem("copper_boots", new Item.Properties().humanoidArmor(ArmorMaterials.COPPER, ArmorType.BOOTS));
    ...
    public static final Item PAINTING = Items.registerItem("painting", (Item.Properties p) -> new HangingEntityItem((EntityType<? extends HangingEntity>)EntityType.PAINTING, (Item.Properties)p));
    ...
    public static final Item OAK_SIGN = Items.registerBlock(Blocks.OAK_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.OAK_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item SPRUCE_SIGN = Items.registerBlock(Blocks.SPRUCE_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.SPRUCE_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item BIRCH_SIGN = Items.registerBlock(Blocks.BIRCH_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.BIRCH_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item JUNGLE_SIGN = Items.registerBlock(Blocks.JUNGLE_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.JUNGLE_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item ACACIA_SIGN = Items.registerBlock(Blocks.ACACIA_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.ACACIA_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item CHERRY_SIGN = Items.registerBlock(Blocks.CHERRY_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.CHERRY_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item DARK_OAK_SIGN = Items.registerBlock(Blocks.DARK_OAK_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.DARK_OAK_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item PALE_OAK_SIGN = Items.registerBlock(Blocks.PALE_OAK_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.PALE_OAK_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item MANGROVE_SIGN = Items.registerBlock(Blocks.MANGROVE_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.MANGROVE_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item BAMBOO_SIGN = Items.registerBlock(Blocks.BAMBOO_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.BAMBOO_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item CRIMSON_SIGN = Items.registerBlock(Blocks.CRIMSON_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.CRIMSON_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item WARPED_SIGN = Items.registerBlock(Blocks.WARPED_SIGN, (Block b, Item.Properties p) -> new SignItem((Block)b, Blocks.WARPED_WALL_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item OAK_HANGING_SIGN = Items.registerBlock(Blocks.OAK_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.OAK_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item SPRUCE_HANGING_SIGN = Items.registerBlock(Blocks.SPRUCE_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.SPRUCE_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item BIRCH_HANGING_SIGN = Items.registerBlock(Blocks.BIRCH_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.BIRCH_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item JUNGLE_HANGING_SIGN = Items.registerBlock(Blocks.JUNGLE_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.JUNGLE_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item ACACIA_HANGING_SIGN = Items.registerBlock(Blocks.ACACIA_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.ACACIA_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item CHERRY_HANGING_SIGN = Items.registerBlock(Blocks.CHERRY_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.CHERRY_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item DARK_OAK_HANGING_SIGN = Items.registerBlock(Blocks.DARK_OAK_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.DARK_OAK_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item PALE_OAK_HANGING_SIGN = Items.registerBlock(Blocks.PALE_OAK_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.PALE_OAK_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item MANGROVE_HANGING_SIGN = Items.registerBlock(Blocks.MANGROVE_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.MANGROVE_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item BAMBOO_HANGING_SIGN = Items.registerBlock(Blocks.BAMBOO_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.BAMBOO_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item CRIMSON_HANGING_SIGN = Items.registerBlock(Blocks.CRIMSON_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.CRIMSON_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item WARPED_HANGING_SIGN = Items.registerBlock(Blocks.WARPED_HANGING_SIGN, (Block b, Item.Properties p) -> new HangingSignItem((Block)b, Blocks.WARPED_WALL_HANGING_SIGN, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item BUCKET = Items.registerItem("bucket", (Item.Properties p) -> new BucketItem(Fluids.EMPTY, (Item.Properties)p), new Item.Properties().stacksTo(16));
    public static final Item WATER_BUCKET = Items.registerItem("water_bucket", (Item.Properties p) -> new BucketItem(Fluids.WATER, (Item.Properties)p), new Item.Properties().craftRemainder(BUCKET).stacksTo(1));
    public static final Item LAVA_BUCKET = Items.registerItem("lava_bucket", (Item.Properties p) -> new BucketItem(Fluids.LAVA, (Item.Properties)p), new Item.Properties().craftRemainder(BUCKET).stacksTo(1));
    public static final Item POWDER_SNOW_BUCKET = Items.registerItem("powder_snow_bucket", (Item.Properties p) -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, (Item.Properties)p), new Item.Properties().stacksTo(1).useItemDescriptionPrefix());
    ...
    public static final Item EGG = Items.registerItem("egg", EggItem::new, new Item.Properties().stacksTo(16).delayedHolderComponent(DataComponents.CHICKEN_VARIANT, ChickenVariants.TEMPERATE));
    public static final Item BLUE_EGG = Items.registerItem("blue_egg", EggItem::new, new Item.Properties().stacksTo(16).delayedHolderComponent(DataComponents.CHICKEN_VARIANT, ChickenVariants.COLD));
    public static final Item BROWN_EGG = Items.registerItem("brown_egg", EggItem::new, new Item.Properties().stacksTo(16).delayedHolderComponent(DataComponents.CHICKEN_VARIANT, ChickenVariants.WARM));
    ...
    public static final Item WHITE_DYE = Items.registerItem("white_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.WHITE));
    public static final Item ORANGE_DYE = Items.registerItem("orange_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.ORANGE));
    public static final Item MAGENTA_DYE = Items.registerItem("magenta_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.MAGENTA));
    public static final Item LIGHT_BLUE_DYE = Items.registerItem("light_blue_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.LIGHT_BLUE));
    public static final Item YELLOW_DYE = Items.registerItem("yellow_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.YELLOW));
    public static final Item LIME_DYE = Items.registerItem("lime_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.LIME));
    public static final Item PINK_DYE = Items.registerItem("pink_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.PINK));
    public static final Item GRAY_DYE = Items.registerItem("gray_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.GRAY));
    public static final Item LIGHT_GRAY_DYE = Items.registerItem("light_gray_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.LIGHT_GRAY));
    public static final Item CYAN_DYE = Items.registerItem("cyan_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.CYAN));
    public static final Item PURPLE_DYE = Items.registerItem("purple_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.PURPLE));
    public static final Item BLUE_DYE = Items.registerItem("blue_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.BLUE));
    public static final Item BROWN_DYE = Items.registerItem("brown_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.BROWN));
    public static final Item GREEN_DYE = Items.registerItem("green_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.GREEN));
    public static final Item RED_DYE = Items.registerItem("red_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.RED));
    public static final Item BLACK_DYE = Items.registerItem("black_dye", DyeItem::new, new Item.Properties().component(DataComponents.DYE, DyeColor.BLACK));
    ...
    public static final Item CRAFTER = Items.registerBlock(Blocks.CRAFTER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item PUMPKIN_SEEDS = Items.registerItem(ItemIds.PUMPKIN_SEEDS, Items.createBlockItemWithCustomItemName(Blocks.PUMPKIN_STEM));
    public static final Item MELON_SEEDS = Items.registerItem(ItemIds.MELON_SEEDS, Items.createBlockItemWithCustomItemName(Blocks.MELON_STEM));
    ...
    public static final Item BREWING_STAND = Items.registerBlock(Blocks.BREWING_STAND, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item ITEM_FRAME = Items.registerItem("item_frame", (Item.Properties p) -> new ItemFrameItem((EntityType<? extends HangingEntity>)EntityType.ITEM_FRAME, (Item.Properties)p));
    public static final Item GLOW_ITEM_FRAME = Items.registerItem("glow_item_frame", (Item.Properties p) -> new ItemFrameItem((EntityType<? extends HangingEntity>)EntityType.GLOW_ITEM_FRAME, (Item.Properties)p));
    ...
    public static final Item SKELETON_SKULL = Items.registerBlock(Blocks.SKELETON_SKULL, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item WITHER_SKELETON_SKULL = Items.registerBlock(Blocks.WITHER_SKELETON_SKULL, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.RARE).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item PLAYER_HEAD = Items.registerBlock(Blocks.PLAYER_HEAD, (Block b, Item.Properties p) -> new PlayerHeadItem((Block)b, Blocks.PLAYER_WALL_HEAD, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item ZOMBIE_HEAD = Items.registerBlock(Blocks.ZOMBIE_HEAD, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item CREEPER_HEAD = Items.registerBlock(Blocks.CREEPER_HEAD, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item DRAGON_HEAD = Items.registerBlock(Blocks.DRAGON_HEAD, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.EPIC).equippableUnswappable(EquipmentSlot.HEAD));
    public static final Item PIGLIN_HEAD = Items.registerBlock(Blocks.PIGLIN_HEAD, (Block b, Item.Properties p) -> new StandingAndWallBlockItem((Block)b, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, Waypoint.addHideAttribute(p)), new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD));
    ...
    public static final Item ENCHANTED_BOOK = Items.registerItem("enchanted_book", new Item.Properties().stacksTo(1).rarity(Rarity.RARE).component(DataComponents.STORED_ENCHANTMENTS, ItemEnchantments.EMPTY).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true));
    ...
    public static final Item COPPER_HORSE_ARMOR = Items.registerItem("copper_horse_armor", new Item.Properties().horseArmor(ArmorMaterials.COPPER));
    ...
    public static final Item NETHERITE_HORSE_ARMOR = Items.registerItem("netherite_horse_armor", new Item.Properties().horseArmor(ArmorMaterials.NETHERITE).fireResistant());
    ...
    public static final Item COMMAND_BLOCK_MINECART = Items.registerItem("command_block_minecart", (Item.Properties p) -> new MinecartItem((EntityType<? extends AbstractMinecart>)EntityType.COMMAND_BLOCK_MINECART, (Item.Properties)p), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC));
    ...
    public static final Item WHITE_BANNER = Items.registerBlock(Blocks.WHITE_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.WHITE_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item ORANGE_BANNER = Items.registerBlock(Blocks.ORANGE_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.ORANGE_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item MAGENTA_BANNER = Items.registerBlock(Blocks.MAGENTA_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.MAGENTA_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIGHT_BLUE_BANNER = Items.registerBlock(Blocks.LIGHT_BLUE_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.LIGHT_BLUE_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item YELLOW_BANNER = Items.registerBlock(Blocks.YELLOW_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.YELLOW_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIME_BANNER = Items.registerBlock(Blocks.LIME_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.LIME_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item PINK_BANNER = Items.registerBlock(Blocks.PINK_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.PINK_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item GRAY_BANNER = Items.registerBlock(Blocks.GRAY_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.GRAY_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item LIGHT_GRAY_BANNER = Items.registerBlock(Blocks.LIGHT_GRAY_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.LIGHT_GRAY_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item CYAN_BANNER = Items.registerBlock(Blocks.CYAN_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.CYAN_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item PURPLE_BANNER = Items.registerBlock(Blocks.PURPLE_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.PURPLE_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BLUE_BANNER = Items.registerBlock(Blocks.BLUE_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.BLUE_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BROWN_BANNER = Items.registerBlock(Blocks.BROWN_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.BROWN_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item GREEN_BANNER = Items.registerBlock(Blocks.GREEN_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.GREEN_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item RED_BANNER = Items.registerBlock(Blocks.RED_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.RED_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    public static final Item BLACK_BANNER = Items.registerBlock(Blocks.BLACK_BANNER, (Block b, Item.Properties p) -> new BannerItem((Block)b, Blocks.BLACK_WALL_BANNER, (Item.Properties)p), new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY));
    ...
    public static final Item WOODEN_SPEAR = Items.registerItem("wooden_spear", new Item.Properties().spear(ToolMaterial.WOOD, 0.65f, 0.7f, 0.75f, 5.0f, 14.0f, 10.0f, 5.1f, 15.0f, 4.6f));
    public static final Item STONE_SPEAR = Items.registerItem("stone_spear", new Item.Properties().spear(ToolMaterial.STONE, 0.75f, 0.82f, 0.7f, 4.5f, 10.0f, 9.0f, 5.1f, 13.75f, 4.6f));
    public static final Item COPPER_SPEAR = Items.registerItem("copper_spear", new Item.Properties().spear(ToolMaterial.COPPER, 0.85f, 0.82f, 0.65f, 4.0f, 9.0f, 8.25f, 5.1f, 12.5f, 4.6f));
    public static final Item IRON_SPEAR = Items.registerItem("iron_spear", new Item.Properties().spear(ToolMaterial.IRON, 0.95f, 0.95f, 0.6f, 2.5f, 8.0f, 6.75f, 5.1f, 11.25f, 4.6f));
    public static final Item GOLDEN_SPEAR = Items.registerItem("golden_spear", new Item.Properties().spear(ToolMaterial.GOLD, 0.95f, 0.7f, 0.7f, 3.5f, 10.0f, 8.5f, 5.1f, 13.75f, 4.6f));
    public static final Item DIAMOND_SPEAR = Items.registerItem("diamond_spear", new Item.Properties().spear(ToolMaterial.DIAMOND, 1.05f, 1.075f, 0.5f, 3.0f, 7.5f, 6.5f, 5.1f, 10.0f, 4.6f));
    public static final Item NETHERITE_SPEAR = Items.registerItem("netherite_spear", new Item.Properties().spear(ToolMaterial.NETHERITE, 1.15f, 1.2f, 0.4f, 2.5f, 7.0f, 5.5f, 5.1f, 8.75f, 4.6f).fireResistant());
    ...
    public static final Item COPPER_NUGGET = Items.registerItem("copper_nugget");
    ...
    public static final Item IRON_NAUTILUS_ARMOR = Items.registerItem("iron_nautilus_armor", new Item.Properties().nautilusArmor(ArmorMaterials.IRON));
    public static final Item GOLDEN_NAUTILUS_ARMOR = Items.registerItem("golden_nautilus_armor", new Item.Properties().nautilusArmor(ArmorMaterials.GOLD));
    public static final Item DIAMOND_NAUTILUS_ARMOR = Items.registerItem("diamond_nautilus_armor", new Item.Properties().nautilusArmor(ArmorMaterials.DIAMOND));
    public static final Item NETHERITE_NAUTILUS_ARMOR = Items.registerItem("netherite_nautilus_armor", new Item.Properties().nautilusArmor(ArmorMaterials.NETHERITE).fireResistant());
    public static final Item COPPER_NAUTILUS_ARMOR = Items.registerItem("copper_nautilus_armor", new Item.Properties().nautilusArmor(ArmorMaterials.COPPER));
    ...
    public static final Item GOAT_HORN = Items.registerItem("goat_horn", InstrumentItem::new, new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1).delayedComponent(DataComponents.INSTRUMENT, context -> new InstrumentComponent(context.getOrThrow(Instruments.PONDER_GOAT_HORN))));
    public static final Item COMPOSTER = Items.registerBlock(Blocks.COMPOSTER);
    public static final Item BARREL = Items.registerBlock(Blocks.BARREL, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SMOKER = Items.registerBlock(Blocks.SMOKER, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item BLAST_FURNACE = Items.registerBlock(Blocks.BLAST_FURNACE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item CAMPFIRE = Items.registerBlock(Blocks.CAMPFIRE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    public static final Item SOUL_CAMPFIRE = Items.registerBlock(Blocks.SOUL_CAMPFIRE, p -> p.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    ...
    public static final Item COPPER_CHEST = Items.registerBlock(Blocks.COPPER_CHEST);
    public static final Item EXPOSED_COPPER_CHEST = Items.registerBlock(Blocks.EXPOSED_COPPER_CHEST);
    public static final Item WEATHERED_COPPER_CHEST = Items.registerBlock(Blocks.WEATHERED_COPPER_CHEST);
    public static final Item OXIDIZED_COPPER_CHEST = Items.registerBlock(Blocks.OXIDIZED_COPPER_CHEST);
    public static final Item WAXED_COPPER_CHEST = Items.registerBlock(Blocks.WAXED_COPPER_CHEST);
    public static final Item WAXED_EXPOSED_COPPER_CHEST = Items.registerBlock(Blocks.WAXED_EXPOSED_COPPER_CHEST);
    public static final Item WAXED_WEATHERED_COPPER_CHEST = Items.registerBlock(Blocks.WAXED_WEATHERED_COPPER_CHEST);
    public static final Item WAXED_OXIDIZED_COPPER_CHEST = Items.registerBlock(Blocks.WAXED_OXIDIZED_COPPER_CHEST);
    public static final Item COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item EXPOSED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.EXPOSED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WEATHERED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.WEATHERED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item OXIDIZED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.OXIDIZED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.WAXED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_EXPOSED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.WAXED_EXPOSED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_WEATHERED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.WAXED_WEATHERED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    public static final Item WAXED_OXIDIZED_COPPER_GOLEM_STATUE = Items.registerBlock(Blocks.WAXED_OXIDIZED_COPPER_GOLEM_STATUE, new Item.Properties().component(DataComponents.BLOCK_STATE, BlockItemStateProperties.EMPTY.with(CopperGolemStatueBlock.POSE, CopperGolemStatueBlock.Pose.STANDING)));
    ...
    private static Item registerSpawnEgg(EntityType<?> type) {
        return Items.registerItem(ResourceKey.create(Registries.ITEM, EntityType.getKey(type).withSuffix("_spawn_egg")), SpawnEggItem::new, new Item.Properties().spawnEgg(type));
    }
    ...
    private static Item registerBlock(Block block, UnaryOperator<Item.Properties> propertiesFunction) {
        return Items.registerBlock(block, (Block b, Item.Properties p) -> new BlockItem((Block)b, (Item.Properties)propertiesFunction.apply((Item.Properties)p)));
    }

    private static Item registerBlock(Block block, Block ... alternatives) {
    ...
    private static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> itemFactory) {
        return Items.registerBlock(block, itemFactory, new Item.Properties());
    }
    ...
    private static Item registerBlock(Block block, BiFunction<Block, Item.Properties, Item> itemFactory, Item.Properties properties) {
        return Items.registerItem(Items.blockIdToItemId(block.builtInRegistryHolder().key()), (Item.Properties p) -> (Item)itemFactory.apply(block, (Item.Properties)p), properties.useBlockDescriptionPrefix());
    }

    private static Item registerItem(String name, Function<Item.Properties, Item> itemFactory) {
        return Items.registerItem(Items.vanillaItemId(name), itemFactory, new Item.Properties());
    }

    private static Item registerItem(String name, Function<Item.Properties, Item> itemFactory, Item.Properties properties) {
        return Items.registerItem(Items.vanillaItemId(name), itemFactory, properties);
    }

    private static Item registerItem(String name, Item.Properties properties) {
        return Items.registerItem(Items.vanillaItemId(name), Item::new, properties);
    }

    private static Item registerItem(String name) {
        return Items.registerItem(Items.vanillaItemId(name), Item::new, new Item.Properties());
    }

    private static Item registerItem(ResourceKey<Item> key, Function<Item.Properties, Item> itemFactory) {
        return Items.registerItem(key, itemFactory, new Item.Properties());
    }
