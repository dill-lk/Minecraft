...
import net.mayaan.world.item.enchantment.effects.AddValue;
import net.mayaan.world.item.enchantment.effects.AllOf;
import net.mayaan.world.item.enchantment.effects.MultiplyValue;
import net.mayaan.world.item.enchantment.effects.RemoveBinomial;
import net.mayaan.world.item.enchantment.effects.ScaleExponentially;
import net.mayaan.world.item.enchantment.effects.SetValue;
