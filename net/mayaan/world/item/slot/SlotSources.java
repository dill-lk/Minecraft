...
import net.mayaan.world.item.slot.ContentsSlotSource;
import net.mayaan.world.item.slot.EmptySlotSource;
import net.mayaan.world.item.slot.FilteredSlotSource;
import net.mayaan.world.item.slot.GroupSlotSource;
import net.mayaan.world.item.slot.LimitSlotSource;
import net.mayaan.world.item.slot.RangeSlotSource;
