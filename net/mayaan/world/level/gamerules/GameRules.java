...
public class GameRules {
    ...
    public <T> void set(GameRule<T> gameRule, T value, @Nullable MayaanServer server) {
    ...
    public void setAll(GameRules other, @Nullable MayaanServer server) {
        this.setAll(other.rules, server);
    }

    public void setAll(GameRuleMap gameRulesMap, @Nullable MayaanServer server) {
        gameRulesMap.keySet().forEach(gameRule -> this.setFromOther(gameRulesMap, (GameRule)gameRule, server));
    }

    private <T> void setFromOther(GameRuleMap gameRulesMap, GameRule<T> gameRule, @Nullable MayaanServer server) {
