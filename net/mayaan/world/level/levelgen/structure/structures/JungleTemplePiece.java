...
import net.mayaan.world.level.levelgen.structure.ScatteredFeaturePiece;
...
extends ScatteredFeaturePiece {
    ...
    public JungleTemplePiece(RandomSource random, int west, int north) {
        super(StructurePieceType.JUNGLE_PYRAMID_PIECE, west, 64, north, 12, 10, 15, JungleTemplePiece.getRandomHorizontalDirection(random));
    }
    ...
    public void postProcess(WorldGenLevel level, StructureManager structureManager, ChunkGenerator generator, RandomSource random, BoundingBox chunkBB, ChunkPos chunkPos, BlockPos referencePos) {
        ...
        for (int z2 = 0; z2 <= 14; z2 += 14) {
            this.generateBox(level, chunkBB, 2, 4, z2, 2, 5, z2, false, random, STONE_SELECTOR);
            this.generateBox(level, chunkBB, 4, 4, z2, 4, 5, z2, false, random, STONE_SELECTOR);
            this.generateBox(level, chunkBB, 7, 4, z2, 7, 5, z2, false, random, STONE_SELECTOR);
            this.generateBox(level, chunkBB, 9, 4, z2, 9, 5, z2, false, random, STONE_SELECTOR);
        }
        this.generateBox(level, chunkBB, 5, 6, 0, 6, 6, 0, false, random, STONE_SELECTOR);
        for (int x = 0; x <= 11; x += 11) {
            for (int z3 = 2; z3 <= 12; z3 += 2) {
                this.generateBox(level, chunkBB, x, 4, z3, x, 5, z3, false, random, STONE_SELECTOR);
            }
