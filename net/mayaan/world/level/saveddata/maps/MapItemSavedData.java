...
import net.mayaan.world.item.component.MapDecorations;
...
import net.mayaan.world.level.saveddata.maps.MapBanner;
...
import net.mayaan.world.level.saveddata.maps.MapFrame;
