...
import net.mayaan.world.level.storage.loot.functions.ApplyBonusCount;
import net.mayaan.world.level.storage.loot.functions.ApplyExplosionDecay;
import net.mayaan.world.level.storage.loot.functions.CopyBlockState;
import net.mayaan.world.level.storage.loot.functions.CopyComponentsFunction;
import net.mayaan.world.level.storage.loot.functions.CopyCustomDataFunction;
import net.mayaan.world.level.storage.loot.functions.CopyNameFunction;
...
import net.mayaan.world.level.storage.loot.functions.EnchantedCountIncreaseFunction;
import net.mayaan.world.level.storage.loot.functions.ExplorationMapFunction;
import net.mayaan.world.level.storage.loot.functions.FillPlayerHead;
import net.mayaan.world.level.storage.loot.functions.FilteredFunction;
import net.mayaan.world.level.storage.loot.functions.FunctionReference;
import net.mayaan.world.level.storage.loot.functions.LimitCount;
import net.mayaan.world.level.storage.loot.functions.LootItemFunction;
import net.mayaan.world.level.storage.loot.functions.ModifyContainerContents;
import net.mayaan.world.level.storage.loot.functions.SequenceFunction;
import net.mayaan.world.level.storage.loot.functions.SetAttributesFunction;
import net.mayaan.world.level.storage.loot.functions.SetBannerPatternFunction;
import net.mayaan.world.level.storage.loot.functions.SetBookCoverFunction;
import net.mayaan.world.level.storage.loot.functions.SetComponentsFunction;
import net.mayaan.world.level.storage.loot.functions.SetContainerContents;
import net.mayaan.world.level.storage.loot.functions.SetContainerLootTable;
import net.mayaan.world.level.storage.loot.functions.SetCustomDataFunction;
import net.mayaan.world.level.storage.loot.functions.SetCustomModelDataFunction;
import net.mayaan.world.level.storage.loot.functions.SetEnchantmentsFunction;
import net.mayaan.world.level.storage.loot.functions.SetFireworkExplosionFunction;
import net.mayaan.world.level.storage.loot.functions.SetFireworksFunction;
import net.mayaan.world.level.storage.loot.functions.SetInstrumentFunction;
...
import net.mayaan.world.level.storage.loot.functions.SetItemFunction;
import net.mayaan.world.level.storage.loot.functions.SetLoreFunction;
import net.mayaan.world.level.storage.loot.functions.SetNameFunction;
import net.mayaan.world.level.storage.loot.functions.SetOminousBottleAmplifierFunction;
...
import net.mayaan.world.level.storage.loot.functions.SetWritableBookPagesFunction;
import net.mayaan.world.level.storage.loot.functions.SetWrittenBookPagesFunction;
import net.mayaan.world.level.storage.loot.functions.SmeltItemFunction;
import net.mayaan.world.level.storage.loot.functions.ToggleTooltips;
