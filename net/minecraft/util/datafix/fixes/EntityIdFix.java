...
extends DataFix {
    private static final Map<String, String> ID_MAP = (Map)DataFixUtils.make((Object)Maps.newHashMap(), map -> {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return TypeRewriteRule.seq((TypeRewriteRule)this.convertUnchecked("item stack entity name hook converter", oldItemStackType, newItemStackType), (TypeRewriteRule)this.fixTypeEverywhere("EntityIdFix", (Type)oldType, (Type)newType, ops -> input -> input.mapFirst(id -> ID_MAP.getOrDefault(id, (String)id))));
    }
}
