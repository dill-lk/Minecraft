...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", itemStackType, input -> {
            ...
            String newValue = ItemStackTheFlatteningFix.updateItem((String)((Pair)id.get()).getSecond(), data);
            if (newValue != null) {
                output = output.set(idF, (Object)Pair.of((Object)References.ITEM_NAME.typeName(), (Object)newValue));
            }
            if (DAMAGE_IDS.contains(((Pair)id.get()).getSecond())) {
                ...
                output = output.set(tagF, tag.set(DSL.remainderFinder(), (Object)tagRest));
            }
            output = output.set(DSL.remainderFinder(), (Object)rest.remove("Damage"));
            return output;
        });
    }
