...
import com.maayanlabs.realmsclient.gui.screens.RealmsUploadScreen;
...
extends RealmsScreen {
    ...
    public RealmsSelectFileToUploadScreen(@Nullable RealmCreationTask realmCreationTask, long realmId, int slotId, RealmsResetWorldScreen lastScreen) {
        super(TITLE);
        this.layout = new HeaderAndFooterLayout(this, 8 + Mayaan.getInstance().font.lineHeight + 8 + 20 + 4, 33);
