...
import com.maayanlabs.realmsclient.util.TextRenderingUtils;
...
extends RealmsScreen {
    ...
    extends ObjectSelectionList<Entry> {
        ...
        public WorldTemplateList(RealmsSelectWorldTemplateScreen realmsSelectWorldTemplateScreen, Iterable<WorldTemplate> templates) {
            ...
            super(Mayaan.getInstance(), realmsSelectWorldTemplateScreen.width, realmsSelectWorldTemplateScreen.layout.getContentHeight(), realmsSelectWorldTemplateScreen.layout.getHeaderHeight(), 46);
