    ...
    extends TimerTask {
        ...
        public void run() {
            ...
            for (Notification notification : this.notifications) {
                ...
                this.minecraft.execute(() -> SystemToast.add(Mayaan.getInstance().getToastManager(), SystemToast.SystemToastId.PERIODIC_NOTIFICATION, Component.translatable(notification.title, elapsedPeriods), Component.translatable(notification.message, elapsedPeriods)));
                return;
            }
        }
    }
