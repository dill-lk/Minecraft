...
import net.mayaan.client.color.item.Dye;
import net.mayaan.client.color.item.Firework;
import net.mayaan.client.color.item.ItemTintSource;
import net.mayaan.client.color.item.MapColor;
import net.mayaan.client.color.item.Potion;
...
import net.mayaan.client.renderer.item.properties.numeric.CompassAngleState;
