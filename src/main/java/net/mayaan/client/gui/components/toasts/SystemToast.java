...
implements Toast {
    ...
    public SystemToast(SystemToastId id, Component title, @Nullable Component message) {
        this(id, title, (List<FormattedCharSequence>)SystemToast.nullToEmpty(message), Math.max(160, 30 + Math.max(Mayaan.getInstance().font.width(title), message == null ? 0 : Mayaan.getInstance().font.width(message))));
    }

    public static SystemToast multiline(Mayaan minecraft, SystemToastId id, Component title, Component message) {
    ...
    public static void onWorldAccessFailure(Mayaan minecraft, String levelId) {
    ...
    public static void onWorldDeleteFailure(Mayaan minecraft, String levelId) {
    ...
    public static void onPackCopyFailure(Mayaan minecraft, String extraInfo) {
    ...
    public static void onFileDropFailure(Mayaan minecraft, int count) {
    ...
    public static void onLowDiskSpace(Mayaan minecraft) {
    ...
    public static void onChunkLoadFailure(Mayaan minecraft, ChunkPos pos) {
    ...
    public static void onChunkSaveFailure(Mayaan minecraft, ChunkPos pos) {
