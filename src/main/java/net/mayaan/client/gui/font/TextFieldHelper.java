...
public class TextFieldHelper {
    ...
    public static Supplier<String> createClipboardGetter(Mayaan minecraft) {
        return () -> TextFieldHelper.getClipboardContents(minecraft);
    }

    public static String getClipboardContents(Mayaan minecraft) {
        return ChatFormatting.stripFormatting(minecraft.keyboardHandler.getClipboard().replaceAll("\\r", ""));
    }

    public static Consumer<String> createClipboardSetter(Mayaan minecraft) {
        return text -> TextFieldHelper.setClipboardContents(minecraft, text);
    }

    public static void setClipboardContents(Mayaan minecraft, String text) {
