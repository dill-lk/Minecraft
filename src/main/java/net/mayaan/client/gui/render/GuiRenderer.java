...
import net.mayaan.client.gui.render.GuiItemAtlas;
import net.mayaan.client.gui.render.TextureSetup;
import net.mayaan.client.gui.render.pip.OversizedItemRenderer;
import net.mayaan.client.gui.render.pip.PictureInPictureRenderer;
import net.mayaan.client.renderer.CubeMap;
...
import net.mayaan.client.renderer.state.gui.GlyphRenderState;
...
implements AutoCloseable {
        ...
        this.renderState.forEachText(text -> {
            ...
            text.ensurePrepared().visit(new Font.GlyphVisitor(){
                ...
                private void accept(TextRenderable glyph) {
                    this.this$0.renderState.submitGlyphToCurrentLayer(new GlyphRenderState(pose, glyph, scissor));
                }
            });
        });
    }
    ...
    private void enableScissor(ScreenRectangle rectangle, RenderPass renderPass) {
        WindowRenderState windowState = Mayaan.getInstance().gameRenderer.getGameRenderState().windowRenderState;
