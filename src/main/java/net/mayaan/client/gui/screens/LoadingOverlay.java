...
extends Overlay {
    ...
    private static final IntSupplier BRAND_BACKGROUND = () -> Mayaan.getInstance().options.darkMojangStudiosBackground().get() != false ? LOGO_BACKGROUND_COLOR_DARK : LOGO_BACKGROUND_COLOR;
    ...
    public LoadingOverlay(Mayaan minecraft, ReloadInstance reload, Consumer<Optional<Throwable>> onFinish, boolean fadeIn) {
    ...
    extends ReloadableTexture {
        ...
        public TextureContents loadContents(ResourceManager resourceManager) throws IOException {
            ResourceProvider vanillaProvider = Mayaan.getInstance().getVanillaPackResources().asProvider();
