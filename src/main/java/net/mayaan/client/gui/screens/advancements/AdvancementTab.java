...
import net.mayaan.client.gui.screens.advancements.AdvancementTabType;
import net.mayaan.client.gui.screens.advancements.AdvancementWidget;
...
public class AdvancementTab {
    ...
    public AdvancementTab(Mayaan minecraft, AdvancementsScreen screen, AdvancementTabType type, int index, AdvancementNode rootNode, DisplayInfo display) {
    ...
    public static @Nullable AdvancementTab create(Mayaan minecraft, AdvancementsScreen screen, int index, AdvancementNode root) {
