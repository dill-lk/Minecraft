...
import net.mayaan.client.gui.screens.recipebook.OverlayRecipeComponent;
import net.mayaan.client.gui.screens.recipebook.RecipeBookComponent;
import net.mayaan.client.gui.screens.recipebook.RecipeButton;
...
public class RecipeBookPage {
    ...
    public void init(Mayaan minecraft, int xo, int yo) {
