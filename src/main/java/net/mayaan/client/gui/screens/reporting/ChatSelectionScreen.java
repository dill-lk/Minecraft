...
import net.mayaan.client.gui.screens.reporting.ChatSelectionLogFiller;
...
import net.mayaan.client.multiplayer.chat.report.ChatReport;
...
extends Screen {
    ...
    implements ChatSelectionLogFiller.Output {
        ...
        public ChatSelectionList(ChatSelectionScreen this$0, Mayaan minecraft, int upperMargin) {
