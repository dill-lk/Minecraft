...
import net.mayaan.client.gui.screens.social.SocialInteractionsPlayerList;
...
extends Screen {
    ...
    public SocialInteractionsScreen(@Nullable Screen lastScreen) {
        ...
        this.updateServerLabel(Mayaan.getInstance());
    }
    ...
    private void updateServerLabel(Mayaan minecraft) {
