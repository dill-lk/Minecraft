...
import net.mayaan.client.gui.screens.worldselection.ConfirmExperimentalFeaturesScreen;
import net.mayaan.client.gui.screens.worldselection.CreateWorldCallback;
import net.mayaan.client.gui.screens.worldselection.DataPackReloadCookie;
import net.mayaan.client.gui.screens.worldselection.ExperimentsScreen;
import net.mayaan.client.gui.screens.worldselection.InitialWorldCreationOptions;
import net.mayaan.client.gui.screens.worldselection.PresetEditor;
...
import net.mayaan.client.gui.screens.worldselection.WorldCreationContextMapper;
import net.mayaan.client.gui.screens.worldselection.WorldCreationGameRulesScreen;
...
extends Screen {
    ...
    public static void openFresh(Mayaan minecraft, Runnable onClose) {
    ...
    public static void openFresh(Mayaan minecraft, Runnable onClose, CreateWorldCallback createWorld) {
    ...
    public static void testWorld(Mayaan minecraft, Runnable onClose) {
    ...
    private static void openCreateWorldScreen(Mayaan minecraft, Runnable onClose, Function<WorldLoader.DataLoadContext, WorldGenSettings> worldGenSettings, WorldCreationContextMapper worldCreationContext, ResourceKey<WorldPreset> worldPreset, CreateWorldCallback createWorld) {
    ...
    public static CreateWorldScreen createFromExisting(Mayaan minecraft, Runnable onClose, LevelSettings levelSettings, WorldCreationContext worldCreationContext, @Nullable Path newDataPackDir) {
    ...
    private CreateWorldScreen(Mayaan minecraft, Runnable onClose, WorldCreationContext settings, Optional<ResourceKey<WorldPreset>> preset, OptionalLong seed, CreateWorldCallback createWorldCallback) {
    ...
    private static void queueLoadScreen(Mayaan minecraft, Component message) {
    ...
    private void onCreate() {
        ...
        if (isDebug) {
            gameRules = MayaanServer.DEFAULT_GAME_RULES.get();
     ...
     */
    private static Optional<LevelStorageSource.LevelStorageAccess> createNewWorldDirectory(Mayaan minecraft, String worldFolder, @Nullable Path tempDataPackDir) {
     ...
     */
    public static @Nullable Path createTempDataPackDirFromExistingWorld(Path sourcePackDir, Mayaan minecraft) {
