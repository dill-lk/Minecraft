...
import com.maayanlabs.blaze3d.TracyBootstrap;
...
import net.mayaan.client.ClientBootstrap;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            TracyClient.reportAppInfo((String)("Mayaan Java Edition " + SharedConstants.getCurrentVersion().name()));
            ...
            Mayaan.fillReport(null, null, launchedVersion, null, report);
            Mayaan.crash(null, gameDir, report);
            return;
        }
        ...
        Mayaan newMinecraft = null;
        try {
            Thread.currentThread().setName("Render thread");
            RenderSystem.initRenderThread();
            newMinecraft = new Mayaan(gameConfig);
        }
            ...
            CrashReportCategory initialization = report.addCategory("Initialization");
            NativeModuleLister.addCrashSection(initialization);
            Mayaan.fillReport(newMinecraft, null, gameConfig.game.launchVersion, null, report);
            Mayaan.crash(newMinecraft, gameConfig.location.gameDirectory, report);
            return;
        }
        Mayaan minecraft = newMinecraft;
        minecraft.run();
        try {
            minecraft.stop();
        }
