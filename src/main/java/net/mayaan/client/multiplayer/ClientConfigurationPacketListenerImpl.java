...
import net.mayaan.client.gui.screens.multiplayer.CodeOfConductScreen;
...
import net.mayaan.client.multiplayer.KnownPacksManager;
import net.mayaan.client.multiplayer.LevelLoadTracker;
import net.mayaan.client.multiplayer.RegistryDataCollector;
...
TickablePacketListener {
    ...
    public ClientConfigurationPacketListenerImpl(Mayaan minecraft, Connection connection, CommonListenerCookie cookie) {
