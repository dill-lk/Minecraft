...
import net.mayaan.client.multiplayer.resolver.AddressCheck;
...
import net.mayaan.client.multiplayer.resolver.ServerAddressResolver;
import net.mayaan.client.multiplayer.resolver.ServerRedirectHandler;
