...
import net.mayaan.client.gui.screens.inventory.BookEditScreen;
import net.mayaan.client.gui.screens.inventory.CommandBlockEditScreen;
import net.mayaan.client.gui.screens.inventory.HangingSignEditScreen;
import net.mayaan.client.gui.screens.inventory.JigsawBlockEditScreen;
import net.mayaan.client.gui.screens.inventory.MinecartCommandBlockEditScreen;
import net.mayaan.client.gui.screens.inventory.SignEditScreen;
import net.mayaan.client.gui.screens.inventory.StructureBlockEditScreen;
import net.mayaan.client.gui.screens.inventory.TestBlockEditScreen;
...
import net.mayaan.client.resources.sounds.BiomeAmbientSoundsHandler;
import net.mayaan.client.resources.sounds.BubbleColumnAmbientSoundHandler;
import net.mayaan.client.resources.sounds.ElytraOnPlayerSoundInstance;
import net.mayaan.client.resources.sounds.RidingEntitySoundInstance;
import net.mayaan.client.resources.sounds.RidingMinecartSoundInstance;
import net.mayaan.client.resources.sounds.SimpleSoundInstance;
import net.mayaan.client.resources.sounds.UnderwaterAmbientSoundHandler;
...
extends AbstractClientPlayer {
    ...
    public LocalPlayer(Mayaan minecraft, ClientLevel level, ClientPacketListener connection, StatsCounter stats, ClientRecipeBook recipeBook, Input lastSentInput, boolean wasSprinting, ChatAbilities chatAbilities) {
