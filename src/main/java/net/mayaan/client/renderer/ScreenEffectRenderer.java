...
public class ScreenEffectRenderer {
    ...
    public ScreenEffectRenderer(Mayaan minecraft, SpriteGetter sprites, MultiBufferSource bufferSource) {
    ...
    private static void renderWater(Mayaan minecraft, PoseStack poseStack, MultiBufferSource bufferSource) {
