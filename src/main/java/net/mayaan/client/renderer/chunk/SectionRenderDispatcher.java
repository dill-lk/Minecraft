...
import com.maayanlabs.blaze3d.vertex.TlsfAllocator;
import com.maayanlabs.blaze3d.vertex.UberGpuBuffer;
...
import net.mayaan.TracingExecutor;
...
import net.mayaan.client.renderer.chunk.CompileTaskDynamicQueue;
import net.mayaan.client.renderer.chunk.CompiledSectionMesh;
import net.mayaan.client.renderer.chunk.RenderRegionCache;
import net.mayaan.client.renderer.chunk.RenderSectionRegion;
...
public class SectionRenderDispatcher {
    ...
    private void runTask() {
        ...
        try {
            ...
            Mayaan.getInstance().delayCrash(CrashReport.forThrowable(e, "Batching sections"));
        }
    }
