...
import net.mayaan.client.renderer.debug.BeeDebugRenderer;
import net.mayaan.client.renderer.debug.BrainDebugRenderer;
import net.mayaan.client.renderer.debug.BreezeDebugRenderer;
import net.mayaan.client.renderer.debug.ChunkBorderRenderer;
import net.mayaan.client.renderer.debug.ChunkCullingDebugRenderer;
import net.mayaan.client.renderer.debug.ChunkDebugRenderer;
import net.mayaan.client.renderer.debug.CollisionBoxRenderer;
import net.mayaan.client.renderer.debug.EntityBlockIntersectionDebugRenderer;
import net.mayaan.client.renderer.debug.EntityHitboxDebugRenderer;
import net.mayaan.client.renderer.debug.GameEventListenerRenderer;
import net.mayaan.client.renderer.debug.GoalSelectorDebugRenderer;
import net.mayaan.client.renderer.debug.HeightMapRenderer;
import net.mayaan.client.renderer.debug.LightDebugRenderer;
import net.mayaan.client.renderer.debug.LightSectionDebugRenderer;
import net.mayaan.client.renderer.debug.NeighborsUpdateRenderer;
import net.mayaan.client.renderer.debug.OctreeDebugRenderer;
import net.mayaan.client.renderer.debug.PathfindingRenderer;
import net.mayaan.client.renderer.debug.PoiDebugRenderer;
import net.mayaan.client.renderer.debug.RaidDebugRenderer;
import net.mayaan.client.renderer.debug.RedstoneWireOrientationsRenderer;
import net.mayaan.client.renderer.debug.SolidFaceRenderer;
import net.mayaan.client.renderer.debug.StructureRenderer;
import net.mayaan.client.renderer.debug.SupportBlockRenderer;
import net.mayaan.client.renderer.debug.VillageSectionsDebugRenderer;
import net.mayaan.client.renderer.debug.WaterDebugRenderer;
