...
import net.mayaan.client.model.animal.armadillo.AdultArmadilloModel;
import net.mayaan.client.model.animal.armadillo.ArmadilloModel;
import net.mayaan.client.model.animal.armadillo.BabyArmadilloModel;
import net.mayaan.client.model.geom.ModelLayers;
import net.mayaan.client.renderer.entity.AgeableMobRenderer;
import net.mayaan.client.renderer.entity.EntityRendererProvider;
import net.mayaan.client.renderer.entity.state.ArmadilloRenderState;
