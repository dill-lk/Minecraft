...
import net.mayaan.client.model.monster.strider.AdultStriderModel;
import net.mayaan.client.model.monster.strider.BabyStriderModel;
...
import net.mayaan.client.renderer.entity.state.StriderRenderState;
