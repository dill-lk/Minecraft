...
extends IntrinsicHolderTagsProvider<EntityType<?>> {
    public EntityTypeTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
        super(output, Registries.ENTITY_TYPE, lookupProvider, (T e) -> e.builtInRegistryHolder().key());
    }
    ...
    protected void addTags(HolderLookup.Provider registries) {
        ...
        this.tag(EntityTypeTags.BURN_IN_DAYLIGHT).add(EntityType.SKELETON, EntityType.STRAY, EntityType.WITHER_SKELETON, EntityType.BOGGED).add((EntityType[])new EntityType[]{EntityType.ZOMBIE, EntityType.ZOMBIE_HORSE, EntityType.ZOMBIE_VILLAGER, EntityType.DROWNED, EntityType.ZOMBIE_NAUTILUS}).add(EntityType.PHANTOM);
