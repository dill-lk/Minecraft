...
import net.mayaan.gametest.framework.GameTestServer;
import net.mayaan.gametest.framework.GlobalTestReporter;
import net.mayaan.gametest.framework.JUnitLikeTestReporter;
...
public class GameTestMainUtil {
    ...
    public static void runGameTestServer(String[] args, Consumer<String> onUniverseCreated) throws Exception {
        ...
        MayaanServer.spin(thread -> GameTestServer.create(thread, levelStorageSource, packRepository, GameTestMainUtil.optionalFromOption(options, tests), (Boolean)options.valueOf(verify), (Integer)options.valueOf(repeatCount)));
    }
