...
import net.mayaan.network.chat.contents.KeybindContents;
import net.mayaan.network.chat.contents.NbtContents;
import net.mayaan.network.chat.contents.ObjectContents;
import net.mayaan.network.chat.contents.PlainTextContents;
import net.mayaan.network.chat.contents.ScoreContents;
import net.mayaan.network.chat.contents.SelectorContents;
