...
public interface IncomingRpcMethod<Params, Result> {
    ...
    public JsonElement apply(MayaanApi var1, @Nullable JsonElement var2, ClientInfo var3);
    ...
    public static <Result> IncomingRpcMethodBuilder<Void, Result> method(Function<MayaanApi, Result> supplier) {
    ...
    public static class IncomingRpcMethodBuilder<Params, Result> {
        ...
        public IncomingRpcMethodBuilder(Function<MayaanApi, Result> supplier) {
    ...
    public static interface ParameterlessRpcMethodFunction<Result> {
        public Result apply(MayaanApi var1, ClientInfo var2);
    }

    @FunctionalInterface
    public static interface RpcMethodFunction<Params, Result> {
        public Result apply(MayaanApi var1, Params var2, ClientInfo var3);
    }
    ...
    {
        @Override
        public JsonElement apply(MayaanApi minecraftApi, @Nullable JsonElement paramsJson, ClientInfo clientInfo) {
