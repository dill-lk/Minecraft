...
import net.mayaan.world.entity.ai.goal.BegGoal;
...
import net.mayaan.world.entity.ai.goal.target.OwnerHurtByTargetGoal;
import net.mayaan.world.entity.ai.goal.target.OwnerHurtTargetGoal;
