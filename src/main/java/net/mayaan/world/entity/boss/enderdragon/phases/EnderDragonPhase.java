...
import net.mayaan.world.entity.boss.enderdragon.phases.DragonChargePlayerPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonDeathPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonHoldingPatternPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonHoverPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonLandingApproachPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonLandingPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonPhaseInstance;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonSittingAttackingPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonSittingFlamingPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonSittingScanningPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonStrafePlayerPhase;
import net.mayaan.world.entity.boss.enderdragon.phases.DragonTakeoffPhase;
