...
import net.mayaan.world.level.levelgen.structure.structures.BuriedTreasurePieces;
...
import net.mayaan.world.level.levelgen.structure.structures.ShipwreckPieces;
