...
import net.mayaan.world.level.timers.TimerCallbacks;

public class TimerQueue<T>
extends SavedData {
    public static final Codec<TimerQueue<MayaanServer>> CODEC = TimerQueue.codec(TimerCallbacks.SERVER_CALLBACKS);
    public static final SavedDataType<TimerQueue<MayaanServer>> TYPE = new SavedDataType<TimerQueue<MayaanServer>>(Identifier.withDefaultNamespace("scheduled_events"), TimerQueue::new, CODEC, DataFixTypes.SAVED_DATA_SCHEDULED_EVENTS);
